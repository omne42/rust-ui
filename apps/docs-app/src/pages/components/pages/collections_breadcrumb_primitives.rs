  ...
  <BreadcrumbList class_name="docs-breadcrumb-list".to_string()>
    ...
    view! {
        <ComponentPage
            ...
            group="Collections"
            description="baseline-compatible breadcrumb primitive family (`Breadcrumb*`) with slot-stable link/page/separator/ellipsis composition contracts and baseline-style source/state marker semantics."
        >
            <Playground
            ...
            <Playground
                ...
                description="Inspect root/link/separator markers like `data-state`, `data-aria-source`, `data-class-source`, `data-href-state`, and `data-content-source` for baseline-compatible breadcrumb contracts."
