...
pub(super) fn visually_hidden() -> AnyView {
    let icon_code = r##"<button type="button" aria-haspopup="menu">
  <span aria-hidden="true">⚙</span>
  <VisuallyHidden>"Open account settings"</VisuallyHidden>
</button>"##;

    let focusable_code = r##"<VisuallyHidden focusable=true>
...
<div id="docs-visually-hidden-target" tabindex="-1">"Details section"</div>"##;
    ...
    view! {
        ...
        >
            <Playground title="Icon Button Accessible Label" code=icon_code>
            ...
            <Playground title="Focusable Skip Link" code=focusable_code>
                <div class="docs-stack">
