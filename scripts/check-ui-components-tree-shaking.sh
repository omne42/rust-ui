...
cargo test -p ui-components --test button_semantics --no-default-features --features component-button,inject-css button_tree_shaking_script_enforces_component_minimal_feature_tree_and_budget
...
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_tree_shaking_feature_gates_are_explicit
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_tree_shaking_script_enforces_component_minimal_feature_tree_and_budget
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_check2_marks_tree_shaking_feature_pruning_contract_complete
...
COLOR_SLIDER_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$COLOR_SLIDER_MIN_FEATURES")"
...
COLOR_WHEEL_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$COLOR_WHEEL_MIN_FEATURES")"
...
COLOR_SWATCH_PICKER_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$COLOR_SWATCH_PICKER_MIN_FEATURES")"
...
cargo check -p ui-components --target wasm32-unknown-unknown --no-default-features --features "$COLOR_SWATCH_PICKER_MIN_FEATURES"
...
COLOR_PICKER_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$COLOR_PICKER_MIN_FEATURES")"
...
DATE_INPUT_GROUP_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$DATE_INPUT_GROUP_MIN_FEATURES")"
...
CHECKBOX_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$CHECKBOX_MIN_FEATURES")"
...
cargo check -p ui-components --target wasm32-unknown-unknown --no-default-features --features "$CHECKBOX_FIELD_MIN_FEATURES"
...
CHECKBOX_GROUP_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$CHECKBOX_GROUP_MIN_FEATURES")"
...
FLIP_CARD_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$FLIP_CARD_MIN_FEATURES")"
...
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_check2_marks_tree_shaking_feature_pruning_contract_complete
...
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_tree_shaking_contract_uses_feature_gated_exports_and_ci_budget_checks
...
MODAL_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$MODAL_MIN_FEATURES")"
...
cargo check -p ui-components --target wasm32-unknown-unknown --no-default-features --features "$MODAL_MIN_FEATURES"
...
OVERLAYS_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$OVERLAYS_MIN_FEATURES")"
...
LIST_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$LIST_MIN_FEATURES")"
...
MENU_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$MENU_MIN_FEATURES")"
...
FIELDSET_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$FIELDSET_MIN_FEATURES")"
...
COMMAND_DIALOG_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$COMMAND_DIALOG_MIN_FEATURES")"
...
DIALOG_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$DIALOG_MIN_FEATURES")"
...
HOVER_CARD_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$HOVER_CARD_MIN_FEATURES")"
...
cargo check -p ui-components --target wasm32-unknown-unknown --no-default-features --features "$HOVER_CARD_MIN_FEATURES"
...
CHART_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$CHART_MIN_FEATURES")"
...
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_tree_shaking_contract_keeps_feature_gated_entrypoints
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_tree_shaking_script_enforces_component_minimal_feature_tree_and_budget
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_check2_marks_tree_shaking_feature_pruning_contract_complete

echo "[tree-shaking] carousel minimal feature tree"
CAROUSEL_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$CAROUSEL_MIN_FEATURES")"
...
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_tree_shaking_contract_keeps_feature_gates_explicit

echo "[tree-shaking] collapsible minimal feature tree"
COLLAPSIBLE_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$COLLAPSIBLE_MIN_FEATURES")"
...
cargo check -p ui-components --target wasm32-unknown-unknown --no-default-features --features "$COLLAPSIBLE_MIN_FEATURES"

echo "[tree-shaking] minimal feature tree"
MIN_TREE_OUTPUT="$(cargo tree -e features -i ui-components -p ui-components --no-default-features --features "$MIN_FEATURES")"
