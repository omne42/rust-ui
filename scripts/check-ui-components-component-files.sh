...
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_component_directory_has_standard_file_layout
...
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: dialog file-placement discipline in AI struct-first section"
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_file_placement_discipline_is_strict_for_component_scope

echo "[component-files] contract: dialog hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: dialog context-compression manifest + rbi projection"
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_file_placement_discipline_is_strict_for_component_scope

echo "[component-files] contract: error-view hyper-structure builder spec is explicitly N/A"
cargo test -p ui-components --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: error-view context-compression manifest + rbi projection"
cargo test -p ui-components --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: autocomplete standard file layout + scoped responsibilities"
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_component_directory_standard_files_follow_contract_and_na_spec
...
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: drop-zone hyper-structure builder spec is explicitly N/A"
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: drop-zone context-compression manifest + rbi projection"
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test drawer_semantics --no-default-features --features component-drawer,inject-css drawer_file_placement_discipline_is_strict_for_component_scope

echo "[component-files] contract: drawer hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test drawer_semantics --no-default-features --features component-drawer,inject-css drawer_hyper_structure_builder_spec_is_not_applicable_for_simple_component
...
cargo test -p ui-components --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_file_placement_discipline_is_strict_and_protocol_free

echo "[component-files] contract: combo-box hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: combo-box context-compression manifest + rbi projection"
cargo test -p ui-components --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: checkbox-group file-placement discipline (no render.rs, spec.rs N/A)"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_file_placement_discipline_is_strict_for_component_scope

echo "[component-files] contract: checkbox-group hyper-structure builder spec is explicitly N/A"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: checkbox-group context-compression manifest + rbi projection"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_component_directory_standard_files_follow_contract_and_na_paths_locally

echo "[component-files] contract: alert-dialog standard file layout + scoped responsibilities"
cargo test -p ui-components --test alert_dialog_semantics --no-default-features --features component-alert_dialog,inject-css alert_dialog_component_directory_standard_files_follow_contract_and_no_spec

echo "[component-files] contract: alert-dialog file-placement discipline in AI struct-first section"
cargo test -p ui-components --test alert_dialog_semantics --no-default-features --features component-alert_dialog,inject-css alert_dialog_file_placement_discipline_is_strict_for_component_scope

echo "[component-files] contract: alert-dialog hyper-structure builder spec is explicitly N/A"
cargo test -p ui-components --test alert_dialog_semantics --no-default-features --features component-alert_dialog,inject-css alert_dialog_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: alert-dialog context-compression manifest + rbi projection"
cargo test -p ui-components --test alert_dialog_semantics --no-default-features --features component-alert_dialog,inject-css alert_dialog_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_component_directory_standard_files_follow_contract_and_na_paths
...
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_component_directory_standard_files_follow_contract_and_na_paths
...
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: color-thumb standard file layout + scoped responsibilities"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: color-swatch standard file layout + scoped responsibilities"
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: color-swatch-picker standard file layout + scoped responsibilities"
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_component_directory_standard_files_follow_contract_and_na_paths
...
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_file_placement_discipline_is_strict_for_component_scope

echo "[component-files] contract: color-swatch-picker hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: color-swatch-picker context-compression manifest + rbi projection"
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_context_compression_manifest_and_rbi_projection_are_present_and_current

echo "[component-files] contract: color-swatch file-placement discipline in AI struct-first section"
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_file_placement_discipline_contract_is_explicit_for_component_scope

echo "[component-files] contract: color-swatch hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_hyper_structure_builder_spec_is_explicitly_na_for_non_complex_component

echo "[component-files] contract: color-swatch context-compression manifest + rbi projection"
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_context_compression_manifest_and_rbi_projection_are_present_and_current

echo "[component-files] contract: color-slider file-placement discipline in AI struct-first section"
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_file_placement_discipline_contract_is_explicit_for_interactive_component_scope

echo "[component-files] contract: color-thumb file-placement discipline in AI struct-first section"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_file_placement_discipline_contract_is_explicit_for_interactive_component_scope

echo "[component-files] contract: color-thumb hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: color-thumb context-compression manifest + rbi projection"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_context_compression_manifest_and_rbi_projection_are_present_and_current

echo "[component-files] contract: color-slider hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_keeps_spec_rs_out_of_simple_component_surface

echo "[component-files] contract: color-slider context-compression manifest + rbi projection"
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_context_compression_manifest_and_rbi_projection_are_present_and_current

echo "[component-files] contract: color-wheel context-compression manifest + rbi projection"
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_context_compression_manifest_and_rbi_projection_are_present_and_current

echo "[component-files] contract: color-editor file-placement discipline in AI struct-first section"
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_file_placement_discipline_contract_is_explicit_for_interactive_component_scope

echo "[component-files] contract: color-editor hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_hyper_structure_builder_spec_is_explicitly_na_for_non_complex_component

echo "[component-files] contract: color-editor context-compression manifest + rbi projection"
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_context_compression_manifest_and_rbi_projection_are_present_and_current

echo "[component-files] contract: checkbox file-placement discipline in AI struct-first section"
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_file_placement_discipline_contract_is_explicit_for_interactive_component_scope_locally

echo "[component-files] contract: checkbox hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_hyper_structure_builder_spec_is_explicitly_na_for_non_complex_component_locally

echo "[component-files] contract: checkbox context-compression manifest + rbi projection"
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_context_compression_manifest_and_rbi_are_present_and_consistent_locally

echo "[component-files] contract: bottom-sheet file-placement discipline in AI struct-first section"
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_file_placement_discipline_contract_is_explicit_for_interactive_component_scope

echo "[component-files] contract: bottom-sheet hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_hyper_structure_builder_spec_is_explicitly_na_for_non_complex_component

echo "[component-files] contract: bottom-sheet context-compression manifest + rbi projection"
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: circular-progress hyper-structure spec builder N/A guard"
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_hyper_structure_builder_spec_contract_is_not_applicable_for_simple_component

echo "[component-files] contract: circular-progress context-compression manifest + rbi projection"
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_context_compression_manifest_and_rbi_are_present_and_consistent

echo "[component-files] contract: coachmark standard file layout + scoped responsibilities"
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_component_directory_standard_files_follow_contract_and_na_paths

echo "[component-files] contract: coachmark file-placement discipline in AI struct-first section"
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_file_placement_discipline_contract_is_explicit_for_interactive_component_scope

echo "[component-files] contract: coachmark hyper-structure builder spec contract is explicitly N/A"
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_hyper_structure_builder_spec_is_explicitly_na_for_non_complex_component

echo "[component-files] contract: coachmark context-compression manifest + rbi projection"
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_context_compression_manifest_and_rbi_are_present_and_consistent

echo "[component-files] contract: chart scoped file responsibilities and forbidden render/spec drift"
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_component_file_responsibilities_stay_layered_and_non_overlapping

echo "[component-files] contract: chart file-placement discipline in AI struct-first section"
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_file_placement_discipline_is_strict_for_struct_first_scope

echo "[component-files] contract: chart hyper-structure builder spec is explicitly N/A"
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_hyper_structure_builder_spec_is_not_applicable_for_simple_component

echo "[component-files] contract: chart context-compression manifest + rbi projection"
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_context_compression_manifest_and_rbi_projection_are_present_and_current
