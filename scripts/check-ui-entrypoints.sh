...
cargo test -p ui --test tabs_semantics tabs_ui_components_forbidden_entrypoint_files_are_absent_and_headless_paths_are_present

echo "[entrypoints] contract: tag entrypoint boundaries and forbidden file guards"
cargo test -p ui --test tag_semantics --no-default-features --features component-tag,inject-css tag_ui_components_forbidden_entrypoint_files_are_absent_and_headless_paths_are_present

echo "[entrypoints] contract: tag-group entrypoint boundaries and forbidden file guards"
cargo test -p ui --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_ui_components_forbidden_entrypoint_files_are_absent_and_headless_paths_are_present
...
cargo test -p ui --test textarea_semantics --no-default-features --features component-textarea,inject-css textarea_ui_components_forbidden_entrypoint_files_are_absent_and_headless_paths_are_present

echo "[entrypoints] contract: time-field entrypoint boundaries and forbidden file guards"
cargo test -p ui --test time_field_semantics --no-default-features --features component-time_field,inject-css time_field_ui_components_forbidden_entrypoint_files_are_absent_and_headless_paths_are_present
...
cargo test -p ui --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: error-view fixed entry files and forbidden file guards"
cargo test -p ui --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: combo-box fixed entry files and forbidden file guards"
cargo test -p ui --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: drop-zone fixed entry files and forbidden file guards"
cargo test -p ui --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_ui_components_fixed_entry_files_follow_layered_boundaries
...
cargo test -p ui --test drawer_semantics --no-default-features --features component-drawer,inject-css drawer_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: checkbox-field fixed entry files and forbidden file guards"
cargo test -p ui --test checkbox_field_semantics --no-default-features --features component-checkbox_field,inject-css checkbox_field_ui_components_fixed_entry_files_follow_layered_boundaries
...
cargo test -p ui --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_ui_components_fixed_entry_files_follow_layered_boundaries_locally
...
cargo test -p ui --test list_module_semantics --no-default-features --features component-list,inject-css list_ui_components_fixed_entry_files_follow_layered_boundaries
...
cargo test -p ui --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: color-slider fixed entry files and forbidden file guards"
cargo test -p ui --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: color-thumb fixed entry files and forbidden file guards"
cargo test -p ui --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: color-swatch fixed entry files and forbidden file guards"
cargo test -p ui --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: color-swatch-picker fixed entry files and forbidden file guards"
cargo test -p ui --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_ui_components_fixed_entry_files_follow_layered_boundaries
...
cargo test -p ui --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: coachmark fixed entry files and forbidden file guards"
cargo test -p ui --lib --no-default-features --features component-coachmark,inject-css coachmark_ui_components_fixed_entry_files_follow_layered_boundaries

echo "[entrypoints] contract: chart fixed entry files and forbidden file guards"
cargo test -p ui --test chart_semantics --no-default-features --features component-chart,inject-css chart_ui_components_fixed_entry_files_follow_layered_boundaries
