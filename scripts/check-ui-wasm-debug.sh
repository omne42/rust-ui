...
cargo test -p ui --test button_semantics --no-default-features --features component-button,inject-css button_wasm_debug_contract_is_feature_gated_and_dev_only

echo "[wasm-debug] contract: tag reuses shared wasm debug contract"
cargo test -p ui --test tag_semantics --no-default-features --features component-tag,inject-css tag_wasm_debug_contract_reuses_global_debug_trace_and_keeps_feature_isolated

echo "[wasm-debug] contract: tag-group reuses shared wasm debug contract"
cargo test -p ui --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_wasm_debug_contract_reuses_global_debug_trace_and_keeps_feature_isolated
...
# cargo test -p ui --test well_semantics --no-default-features --features component-well,inject-css well_wasm_debug_observability_reuses_global_trace_overlay_with_timestamped_events
...
cargo test -p ui --test swatch_semantics --no-default-features --features component-swatch,inject-css swatch_wasm_debug_contract_reuses_global_debug_trace_and_keeps_feature_isolated

echo "[wasm-debug] contract: textarea reuses shared wasm debug contract"
cargo test -p ui --test textarea_semantics --no-default-features --features component-textarea,inject-css textarea_wasm_debug_contract_reuses_global_debug_trace_and_keeps_feature_isolated

echo "[wasm-debug] contract: circular-progress stays wasm debug feature-isolated and reuses global trace entry"
cargo test -p ui --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_wasm_debug_contract_is_explicitly_na_and_feature_isolated

echo "[wasm-debug] contract: time-field reuses shared wasm debug contract"
cargo test -p ui --test time_field_semantics --no-default-features --features component-time_field,inject-css time_field_wasm_debug_contract_reuses_global_debug_trace_and_keeps_feature_isolated
...
cargo test -p ui --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated

echo "[wasm-debug] contract: coachmark reuses global wasm debug trace contract"
cargo test -p ui --lib --no-default-features --features component-coachmark,inject-css coachmark_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated

echo "[wasm-debug] contract: checkbox-field stays wasm debug feature-isolated and reuses global trace entry"
cargo test -p ui --test checkbox_field_semantics --no-default-features --features component-checkbox_field,inject-css checkbox_field_wasm_debug_contract_is_explicitly_na_and_feature_isolated

echo "[wasm-debug] contract: checkbox stays wasm debug feature-isolated and reuses global trace entry"
cargo test -p ui --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_wasm_debug_contract_is_explicitly_na_and_feature_isolated_locally

echo "[wasm-debug] contract: checkbox-group stays wasm debug feature-isolated and reuses global debug overlay entry"
cargo test -p ui --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_wasm_debug_contract_is_explicitly_na_and_feature_isolated
...
cargo test -p ui --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated

echo "[wasm-debug] contract: chart reuses shared wasm debug contract"
cargo test -p ui --test chart_semantics --no-default-features --features component-chart,inject-css chart_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated

echo "[wasm-debug] contract: carousel reuses shared wasm debug contract"
cargo test -p ui --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated
...
cargo test -p ui --test command_dialog_semantics --no-default-features --features component-command_dialog,inject-css command_dialog_wasm_debug_contract_reuses_global_trace_and_keeps_feature_isolated

echo "[wasm-debug] contract: modal reuses shared wasm debug contract"
cargo test -p ui --test modal_semantics --no-default-features --features component-modal,inject-css modal_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated
...
cargo test -p ui --test drawer_semantics --no-default-features --features component-drawer,inject-css drawer_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated

echo "[wasm-debug] contract: hover-card reuses shared wasm debug contract"
cargo test -p ui --test hover_card_semantics --no-default-features --features component-hover_card,inject-css hover_card_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated

echo "[wasm-debug] contract: list keeps wasm debug N/A boundary and feature isolation"
cargo test -p ui --test list_module_semantics --no-default-features --features component-list,inject-css list_wasm_debug_contract_is_explicitly_na_and_feature_isolated
...
cargo test -p ui --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_wasm_debug_contract_reuses_global_debug_trace_and_keeps_feature_isolated
...
cargo test -p ui --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_wasm_debug_contract_is_explicitly_na_and_feature_isolated

echo "[wasm-debug] contract: color-swatch stays wasm debug feature-isolated and reuses global trace entry"
cargo test -p ui --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_wasm_debug_contract_is_explicitly_na_and_feature_isolated

echo "[wasm-debug] contract: color-thumb reuses shared wasm debug trace and keeps feature isolated"
cargo test -p ui --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_wasm_debug_contract_reuses_shared_trace_and_stays_feature_isolated

echo "[wasm-debug] contract: color-swatch-picker reuses global wasm debug trace contract"
cargo test -p ui --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated
