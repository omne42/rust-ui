...
cargo test -p ui-components --test button_semantics --no-default-features --features component-button,inject-css button_dx_workbench_supports_optional_state_persistence_and_isolated_canvas
...
cargo test -p ui-components --test button_copy_semantics --no-default-features --features component-button_copy,inject-css button_copy_dx_workbench_supports_optional_state_persistence_and_isolated_canvas
...
cargo test -p ui-components --test action_button_semantics --no-default-features --features component-button,inject-css action_button_dx_playground_supports_css_hot_reload_without_wasm_rebuild
...
cargo test -p ui-components --test action_button_semantics --no-default-features --features component-button,inject-css action_button_dx_workbench_supports_optional_state_persistence_and_isolated_canvas
...
cargo test -p ui-components --test tabs_semantics --no-default-features --features component-tabs,inject-css tabs_dx_playground_supports_css_hot_reload_without_wasm_rebuild
cargo test -p ui-components --test tabs_semantics --no-default-features --features component-tabs,inject-css tabs_dx_workbench_supports_optional_state_persistence_and_isolated_canvas
...
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_dx_check_script_covers_docs_product_copy_paste_ready_contract
...
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_dx_check_script_covers_docs_sync_and_state_matrix_contract
...
cargo test -p ui-components --test fieldset_semantics --no-default-features --features component-fieldset,inject-css fieldset_check2_documents_interactive_playground_rules
...
cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_dx_check_script_covers_source_first_copy_paste_ready_contract
...
cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_dx_check_script_covers_heroui_benchmark_docs_sync_contract
...
cargo test -p ui-components --test checkbox_field_semantics --no-default-features --features component-checkbox_field,inject-css checkbox_field_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na

echo "[dx] contract: checkbox-field docs product copy-paste-ready + streaming/snapshot contract"
cargo test -p ui-components --test checkbox_field_semantics --no-default-features --features component-checkbox_field,inject-css checkbox_field_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test checkbox_field_semantics --no-default-features --features component-checkbox_field,inject-css checkbox_field_dx_check_script_covers_heroui_benchmark_docs_sync_contract

echo "[dx] contract: checkbox playground css hot-reload + isolated canvas"
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na_locally
...
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na
echo "[dx] contract: checkbox-group docs examples + api/state matrix sync with logic API/defaults"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_documents_docs_sync_and_state_matrix_rules
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_docs_examples_and_state_matrix_sync_with_logic_api_names_and_defaults
echo "[dx] contract: checkbox-group documentation-as-product keeps beginner-first docs entry"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_documents_documentation_as_product_rules
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_documentation_entry_exists_with_beginner_first_progression
echo "[dx] contract: checkbox-group interactive playground docs acceptance surface"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_documents_interactive_playground_rules
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_docs_app_provides_interactive_playground_for_props_state_and_preview
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_interactive_playground_reuses_repeatable_semantic_e2e_flow
echo "[dx] contract: checkbox-group source-first docs are copy-paste-ready with real paths and deps"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_documents_source_first_copy_paste_ready_rules
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_docs_source_first_copy_paste_ready_with_real_paths_and_dependencies
echo "[dx] contract: checkbox-group heroui benchmark strategy + docs entry synchronization"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_documents_heroui_benchmark_docs_sync_rules
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_heroui_strategy_and_component_docs_are_synchronized_and_indexable
echo "[dx] contract: checkbox-group dx script coverage includes heroui benchmark docs-sync checks"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_dx_check_script_covers_heroui_benchmark_docs_sync_contract
echo "[dx] contract: checkbox-group docs product copy-paste-ready + streaming/snapshot contract"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot

echo "[dx] contract: bottom-sheet playground css hot-reload + isolated workbench"
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_dx_playground_supports_hot_reload_context_and_isolated_workbench
echo "[dx] contract: bottom-sheet docs product copy-paste-ready + streaming/snapshot + state matrix"
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_dx_playground_supports_hot_reload_context_and_isolated_workbench
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_dx_check_script_covers_heroui_benchmark_docs_sync_contract
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_check2_marks_heroui_benchmark_docs_sync_contract_complete
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_check2_marks_source_first_copy_paste_ready_item_complete
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_dx_check_script_covers_docs_sync_and_state_matrix_contract
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_dx_check_script_covers_documentation_as_product_contract
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_dx_check_script_covers_interactive_playground_contract
...
cargo test -p ui-components --test modal_semantics --no-default-features --features component-modal,inject-css modal_docs_are_copy_paste_ready_with_imports_and_streaming_snapshot_contract
...
cargo test -p ui-components --test drawer_semantics --no-default-features --features component-drawer,inject-css drawer_docs_are_copy_paste_ready_with_imports_and_streaming_snapshot_contract
...
cargo test -p ui-components --test hover_card_semantics --no-default-features --features component-hover_card,inject-css hover_card_docs_are_copy_paste_ready_with_imports_and_streaming_snapshot_contract
...
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na
echo "[dx] contract: list docs product copy-paste-ready + streaming/snapshot contract"
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_dx_playground_supports_hot_reload_context_and_isolated_workbench
...
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na
...
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_dx_playground_supports_css_hot_reload_and_context_with_optional_persist_na

echo "[dx] contract: color-thumb docs product copy-paste-ready + state matrix + streaming/snapshot"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_dx_check_script_covers_docs_sync_and_state_matrix_contract
...
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_dx_check_script_covers_interactive_playground_contract
...
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_dx_check_script_covers_source_first_copy_paste_ready_contract
...
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na
...
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_dx_workbench_supports_hot_style_feedback_and_optional_state_preserve
...
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot
...
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_dx_check_script_covers_docs_sync_and_state_matrix_contract
...
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_dx_check_script_covers_documentation_as_product_contract
...
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_dx_check_script_covers_interactive_playground_contract
...
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_dx_check_script_covers_source_first_copy_paste_ready_contract
...
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_dx_workbench_supports_optional_state_persistence_and_isolated_canvas
...
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na
