...
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe
...
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe
...
cargo test -p ui-components --test button_semantics button_motion_sanitizes_custom_contract_values
cargo test -p ui-components --test button_semantics button_reduced_motion_and_ssr_wasm_semantics_contract_is_enforced
...
cargo test -p ui-components --test checkbox_field_semantics --no-default-features --features component-checkbox_field,inject-css checkbox_field_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe

echo "[platform] checkbox motion contractualization (spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe_locally

echo "[platform] list motion contractualization (spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe

echo "[platform] color-editor motion contractualization (composed spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe

echo "[platform] color-slider motion contractualization (spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe

echo "[platform] color-swatch motion contractualization (spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe

echo "[platform] color-swatch-picker motion contractualization (spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe

echo "[platform] chart reduced-motion/ssr/wasm contract"
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_reduced_motion_ssr_wasm_branches_keep_semantics_consistent

echo "[platform] chart motion contractualization (spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe

echo "[platform] carousel motion contractualization (spring contract + reduced-motion + non-wasm no-op)"
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe
...
cargo test -p ui-components --test hover_card_semantics --no-default-features --features component-hover_card,inject-css hover_card_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe
