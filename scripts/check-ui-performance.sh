...
cargo test -p ui --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks
...
cargo test -p ui --test button_copy_semantics button_copy_performance_governance_budget_is_defined_and_blocking

echo "[perf] contract: action-button performance governance"
cargo test -p ui --test action_button_semantics action_button_performance_governance_budget_is_defined_and_blocking

echo "[perf] contract: share-button performance governance"
cargo test -p ui --test share_button_semantics share_button_performance_governance_budget_is_defined_and_blocking
...
cargo test -p ui --test tag_semantics --no-default-features --features component-tag,inject-css tag_performance_governance_budget_is_defined_and_blocking

echo "[perf] contract: tag-group performance governance"
cargo test -p ui --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_performance_governance_budget_is_defined_and_blocking
...
cargo test -p ui --test time_field_semantics --no-default-features --features component-time_field,inject-css time_field_performance_governance_budget_is_defined_and_blocking
...
cargo test -p ui --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement

echo "[perf] contract: autocomplete semantic test priority"
cargo test -p ui --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks
...
cargo test -p ui --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks
...
cargo test -p ui --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_performance_governance_budget_is_defined_and_blocking

echo "[perf] contract: combo-box semantics/perf matrix"
cargo test -p ui --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement

echo "[perf] contract: combo-box semantic test priority"
cargo test -p ui --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks
