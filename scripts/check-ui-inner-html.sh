...
cargo test -p ui --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_inner_html_usage_is_forbidden_in_component_and_docs_examples_locally
...
cargo test -p ui --test tag_semantics --no-default-features --features component-tag,inject-css tag_inner_html_usage_is_forbidden_in_component_and_docs_examples

echo "[inner-html] contract: tag-group component/docs reject raw html injection"
cargo test -p ui --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_inner_html_usage_is_forbidden_in_component_and_docs_examples
...
cargo test -p ui --test swatch_semantics --no-default-features --features component-swatch,inject-css swatch_inner_html_usage_is_forbidden_in_component_and_docs_examples

echo "[inner-html] contract: textarea component/docs reject raw html injection"
cargo test -p ui --test textarea_semantics --no-default-features --features component-textarea,inject-css textarea_inner_html_usage_is_forbidden_in_component_and_docs_examples

echo "[inner-html] contract: circular-progress component/docs reject raw html injection"
cargo test -p ui --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_inner_html_usage_is_forbidden_in_component_and_docs_examples

echo "[inner-html] contract: time-field component/docs reject raw html injection"
cargo test -p ui --test time_field_semantics --no-default-features --features component-time_field,inject-css time_field_inner_html_usage_is_forbidden_in_component_and_docs_examples
...
cargo test -p ui --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_inner_html_usage_is_explicitly_na_and_guarded

echo "[inner-html] contract: chart component/docs inner_html is explicitly N/A and guarded"
cargo test -p ui --test chart_semantics --no-default-features --features component-chart,inject-css chart_inner_html_usage_is_explicitly_na_and_guarded

echo "[inner-html] contract: carousel component/docs inner_html is explicitly N/A and guarded"
cargo test -p ui --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_inner_html_usage_is_explicitly_na_and_guarded
...
cargo test -p ui --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_inner_html_usage_is_forbidden_in_component_and_docs_examples
...
cargo test -p ui --test modal_semantics --no-default-features --features component-modal,inject-css modal_inner_html_usage_is_forbidden_in_component_and_docs_examples
...
cargo test -p ui --test drawer_semantics --no-default-features --features component-drawer,inject-css drawer_inner_html_usage_is_forbidden_in_component_and_docs_examples
...
cargo test -p ui --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_inner_html_usage_is_forbidden_in_component_and_docs_examples

echo "[inner-html] contract: color-swatch component/docs reject raw html injection"
cargo test -p ui --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_inner_html_usage_is_forbidden_in_component_and_docs_examples

echo "[inner-html] contract: color-thumb component/docs reject raw html injection"
cargo test -p ui --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_inner_html_usage_is_forbidden_in_component_and_docs_examples

echo "[inner-html] contract: color-swatch-picker component/docs reject raw html injection"
cargo test -p ui --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_inner_html_usage_is_forbidden_in_component_and_docs_examples
...
cargo test -p ui --test hover_card_semantics --no-default-features --features component-hover_card,inject-css hover_card_inner_html_usage_is_explicitly_na_and_guarded

echo "[inner-html] contract: list component/docs inner_html is explicitly N/A and guarded"
cargo test -p ui --test list_module_semantics --no-default-features --features component-list,inject-css list_inner_html_usage_is_explicitly_na_and_guarded
