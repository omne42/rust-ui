...
echo "[e2e-alert-dialog] contract: checklist e2e-selector/stable-wait governance"
...
echo "[e2e-alert-dialog] contract: semantic selectors + settled waits"
...
echo "[e2e-alert-dialog] contract: overlay ready/settled semantic breakpoints"
...
echo "[e2e-alert-dialog] contract: repeatable key flow with semantic breakpoints"
