...
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: checkbox-group snapshot baseline stays default capability"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_documents_snapshot_as_default_baseline_capability
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_snapshot_baseline_consumes_complete_result_and_renders_stably

echo "[streaming] contract: checkbox-group streaming required/optional classification stays scoped and explicit"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_check2_marks_streaming_scope_as_optional_with_snapshot_fallback
...
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_check2_documents_streaming_definition_is_llm_output_only_with_two_modes
...
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: list snapshot baseline stays default capability"
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_check2_documents_snapshot_as_default_baseline_capability
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_snapshot_baseline_consumes_complete_result_and_renders_stably

echo "[streaming] contract: list streaming required/optional classification stays scoped and explicit"
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_check2_marks_streaming_scope_as_optional_with_snapshot_fallback
...
cargo test -p ui-components --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_check2_documents_streaming_definition_is_llm_output_only_with_two_modes
...
cargo test -p ui-components --test modal_semantics --no-default-features --features component-modal,inject-css modal_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: alert-dialog checklist pins two-mode streaming definition (LLM-only scope)"
cargo test -p ui-components --test alert_dialog_semantics --no-default-features --features component-alert_dialog,inject-css alert_dialog_check2_documents_streaming_definition_is_llm_output_only_with_two_modes
...
cargo test -p ui-components --test drawer_semantics --no-default-features --features component-drawer,inject-css drawer_check2_documents_streaming_definition_is_llm_output_only_with_two_modes
...
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_check2_documents_streaming_definition_is_llm_output_only_with_two_modes
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: color-thumb checklist pins two-mode streaming definition (LLM-only scope)"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: color-thumb snapshot baseline stays default capability"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_snapshot_baseline_consumes_complete_result_and_renders_stably
...
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: color-swatch-picker checklist pins two-mode streaming definition (LLM-only scope)"
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_check2_documents_streaming_definition_is_llm_output_only_with_two_modes
...
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_check2_documents_snapshot_as_default_baseline_capability
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_snapshot_baseline_consumes_complete_result_and_renders_stably
...
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: color-wheel checklist pins two-mode streaming definition (LLM-only scope)"
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: color-wheel snapshot baseline stays default capability"
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_snapshot_baseline_consumes_complete_result_and_renders_stably
...
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_snapshot_baseline_consumes_complete_result_and_renders_stably
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_snapshot_baseline_consumes_complete_result_and_renders_stably
...
cargo test -p ui-components --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: drop-zone checklist pins two-mode streaming definition (LLM-only scope)"
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_check2_documents_streaming_definition_is_llm_output_only_with_two_modes
...
cargo test -p ui-components --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_snapshot_baseline_and_streaming_fallback_contract_are_explicit
cargo test -p ui-components --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_check2_documents_streaming_required_optional_classification_rules
cargo test -p ui-components --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_streaming_optional_scope_keeps_role_aria_and_data_markers_continuous
cargo test -p ui-components --test tag_group_semantics --no-default-features --features component-tag_group,inject-css tag_group_streaming_validation_retry_resilience_boundaries_stay_outside_component_layer
...
cargo test -p ui-components --test textarea_semantics --no-default-features --features component-textarea,inject-css textarea_check2_documents_streaming_definition_is_llm_output_only_with_two_modes

echo "[streaming] contract: textarea snapshot baseline stays default capability"
cargo test -p ui-components --test textarea_semantics --no-default-features --features component-textarea,inject-css textarea_check2_documents_snapshot_as_default_baseline_capability
cargo test -p ui-components --test textarea_semantics --no-default-features --features component-textarea,inject-css textarea_snapshot_baseline_consumes_complete_result_and_renders_stably
