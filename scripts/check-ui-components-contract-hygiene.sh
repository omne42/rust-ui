...
cargo test -p ui-components --test button_semantics button_styles_use_defensive_variable_fallback_chain_locally

echo "[contract-hygiene] contract: button css stays in @layer ui and runtime styles stay css-variable-only"
cargo test -p ui-components --test button_semantics button_cascade_layer_and_runtime_style_contract_is_enforced_locally
...
cargo test -p ui-components --test style_rules --no-default-features --features inject-css text_line_height_legacy_ratios_are_allowlisted_and_no_new_ones

echo "[contract-hygiene] contract: checkbox-field css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test checkbox_field_semantics --no-default-features --features component-checkbox_field,inject-css checkbox_field_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_inner_html_usage_is_absent_and_untrusted_html_paths_are_blocked

echo "[contract-hygiene] contract: checkbox-group styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: checkbox-group css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_motion_contract_is_builtin_and_attached_with_reduced_motion_and_non_wasm_noop

echo "[contract-hygiene] contract: checkbox-group agent-contract markers are schema-typed, traceable, and whitelist-rendered"
cargo test -p ui-components --test checkbox_group_semantics --no-default-features --features component-checkbox_group,inject-css checkbox_group_agent_contract_is_schema_typed_traceable_and_whitelist_rendered

echo "[contract-hygiene] contract: checkbox styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_styles_use_defensive_variable_fallback_chain_locally

echo "[contract-hygiene] contract: checkbox css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test checkbox_semantics --no-default-features --features component-checkbox,inject-css checkbox_cascade_layer_and_runtime_style_contract_is_enforced_locally
...
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: chart styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_styles_use_defensive_variable_fallback_chain
...
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: carousel agent-contract schema markers stay typed, traceable, and whitelist-rendered"
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_agent_contract_schema_markers_are_typed_traceable_and_whitelist_rendered
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_check2_marks_agent_contract_schema_item_complete
...
cargo test -p ui-components --test fieldset_semantics --no-default-features --features component-fieldset,inject-css fieldset_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: color-slider styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: color-swatch styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: color-thumb styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: color-thumb css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_motion_contract_is_builtin_and_attached_with_reduced_motion_and_non_wasm_noop
...
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_semantics_priority_contract_prefers_semantic_assertions_over_snapshot_only

echo "[contract-hygiene] contract: color-thumb documentation-as-product stays beginner-friendly with README/docs entry"
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_check2_documents_documentation_as_product_rules
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_docs_entry_exists_as_readme_or_equivalent_docs_app_page
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_docs_are_beginner_friendly_with_default_then_advanced_path
cargo test -p ui-components --test color_thumb_semantics --no-default-features --features component-color_thumb,inject-css color_thumb_docs_hello_world_snippet_is_zero_threshold_and_not_architecture_wiring

echo "[contract-hygiene] contract: color-swatch-picker styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: color-swatch-picker css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_contract_hygiene_script_covers_source_first_copy_paste_ready_contract
...
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_contract_hygiene_script_covers_heroui_benchmark_docs_sync_contract
...
cargo test -p ui-components --test color_swatch_picker_semantics --no-default-features --features component-color_swatch_picker,inject-css color_swatch_picker_semantics_priority_contract_prefers_semantic_assertions_over_snapshot_only
...
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test color_swatch_semantics --no-default-features --features component-color_swatch,inject-css color_swatch_semantics_priority_contract_prefers_semantic_assertions_over_snapshot_only

echo "[contract-hygiene] contract: color-slider css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test color_wheel_semantics --no-default-features --features component-color_wheel,inject-css color_wheel_check2_documents_semantics_first_testing_rules

echo "[contract-hygiene] contract: color-slider docs product copy-paste-ready playground matrix"
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_docs_page_covers_primary_playgrounds
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_docs_playgrounds_lock_state_matrix_contract_values
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_check2_documents_docs_product_copy_paste_ready_contract
...
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_check2_documents_documentation_as_product_rules
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_docs_entry_exists_as_readme_or_equivalent_docs_app_page
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_docs_are_beginner_friendly_with_default_then_advanced_path
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_docs_hello_world_snippet_is_zero_threshold_and_not_architecture_wiring
...
cargo test -p ui-components --test color_slider_semantics --no-default-features --features component-color_slider,inject-css color_slider_semantics_priority_contract_prefers_semantic_assertions_over_snapshot_only
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_docs_page_covers_primary_playgrounds
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_docs_playgrounds_lock_state_matrix_contract_values
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_docs_examples_parameter_and_state_matrix_stay_synced_with_logic_defaults
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_check2_documents_documentation_as_product_rules
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_docs_entry_exists_as_readme_or_equivalent_docs_app_page
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_docs_are_beginner_friendly_with_default_then_advanced_path
...
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_check2_documents_docs_product_copy_paste_ready_contract
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_contract_hygiene_script_covers_source_first_copy_paste_ready_contract
cargo test -p ui-components --test color_editor_semantics --no-default-features --features component-color_editor,inject-css color_editor_semantics_priority_contract_prefers_semantic_assertions_over_snapshot_only

echo "[contract-hygiene] contract: combo-box styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: autocomplete styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: autocomplete css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_motion_contract_is_builtin_and_attached_with_reduced_motion_and_non_wasm_noop

echo "[contract-hygiene] contract: autocomplete ui-components fixed-entry files stay correctly located and scoped"
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_ui_components_fixed_entry_files_are_correctly_located_and_scoped
...
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_streaming_term_is_limited_to_llm_output_render_modes

echo "[contract-hygiene] contract: autocomplete snapshot rendering is foundational and complete-config stable"
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_snapshot_is_foundational_and_complete_config_renders_stably

echo "[contract-hygiene] contract: autocomplete streaming is optional with snapshot fallback and explicit output status"
cargo test -p ui-components --test autocomplete_semantics --no-default-features --features component-autocomplete,inject-css autocomplete_streaming_requirement_is_optional_with_snapshot_fallback_and_explicit_status
...
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: drop-zone css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_cascade_layer_and_runtime_style_contract_is_enforced

echo "[contract-hygiene] contract: drop-zone motion contract is built-in and safely attached across reduced-motion + non-wasm"
cargo test -p ui-components --test drop_zone_semantics --no-default-features --features component-drop_zone,inject-css drop_zone_motion_contract_is_builtin_and_attached_with_reduced_motion_and_non_wasm_noop
...
cargo test -p ui-components --test combo_box_semantics --no-default-features --features component-combo_box,inject-css combo_box_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test chart_semantics --no-default-features --features component-chart,inject-css chart_cascade_layer_and_runtime_style_contract_is_enforced

echo "[contract-hygiene] contract: carousel css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test carousel_semantics --no-default-features --features component-carousel,inject-css carousel_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: error-view css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test error_view_semantics --no-default-features --features component-error_view,inject-css error_view_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test alert_dialog_semantics --no-default-features --features component-alert_dialog,inject-css alert_dialog_styles_use_defensive_variable_fallback_chain
...
cargo test -p ui-components --test hover_card_semantics --no-default-features --features component-hover_card,inject-css hover_card_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: hover-card css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test hover_card_semantics --no-default-features --features component-hover_card,inject-css hover_card_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: dialog css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test dialog_semantics --no-default-features --features component-dialog,inject-css dialog_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test alert_dialog_semantics --no-default-features --features component-alert_dialog,inject-css alert_dialog_cascade_layer_and_runtime_style_contract_is_enforced

echo "[contract-hygiene] contract: bottom-sheet styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: bottom-sheet css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test bottom_sheet_semantics --no-default-features --features component-bottom_sheet,inject-css bottom_sheet_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_styles_use_defensive_variable_fallback_chain_with_ui_theme_ssot_terminals

echo "[contract-hygiene] contract: collapsible styles keep defensive fallback chain with ui-theme SSOT terminals"
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_styles_use_defensive_variable_fallback_chain

echo "[contract-hygiene] contract: collapsible css is aggregated in @layer ui and runtime style is css-variable-only"
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_motion_contract_is_builtin_and_attached_with_reduced_motion_and_non_wasm_noop

echo "[contract-hygiene] contract: collapsible ui-components fixed entry files stay in canonical boundaries"
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_ui_components_fixed_entry_files_follow_contract

echo "[contract-hygiene] contract: collapsible component directory keeps standard file layout boundaries"
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_component_directory_standard_files_stay_in_canonical_layout

echo "[contract-hygiene] contract: collapsible file layout discipline keeps canonical component directory"
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_file_layout_discipline_keeps_canonical_component_directory

echo "[contract-hygiene] contract: collapsible hyper-structure builder spec.rs stays explicit N/A for simple scope"
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_hyper_structure_builder_spec_rs_is_not_applicable_for_simple_component

echo "[contract-hygiene] contract: collapsible context-compression manifest + rbi projection stay present and current"
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_context_compression_manifest_and_rbi_projection_are_present_and_current
...
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_streaming_term_is_limited_to_llm_output_render_modes
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_snapshot_is_foundational_and_complete_config_renders_stably
cargo test -p ui-components --test collapsible_semantics --no-default-features --features component-collapsible,inject-css collapsible_streaming_requirement_is_optional_with_snapshot_fallback_and_explicit_status
...
cargo test -p ui-components --lib --no-default-features --features component-coachmark,inject-css coachmark_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test circular_progress_semantics --no-default-features --features component-circular_progress,inject-css circular_progress_cascade_layer_and_runtime_style_contract_is_enforced
...
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_styles_use_defensive_variable_fallback_chain_with_ui_theme_ssot_terminals

echo "[contract-hygiene] contract: list css is aggregated in @layer ui and runtime style stays css-variable-only"
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_cascade_layer_contract_is_aggregated_in_ui_layer_and_rejects_plain_inline_style_rules

echo "[contract-hygiene] contract: list agent-contract schema-like markers + whitelist-safe render path"
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_check2_documents_agent_contract_schema_governance_rules
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_agent_contract_is_schema_typed_and_machine_readable
...
cargo test -p ui-components --test list_module_semantics --no-default-features --features component-list,inject-css list_agent_contract_render_path_is_whitelist_safe_and_script_injection_free
