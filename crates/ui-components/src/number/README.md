...
- `CSS Test`：加载 `crates/ui-components/src/number/styles.rs` 的原始样式，可在 scoped 区域实时覆盖并观察结果。
...
- 真实源码落点：
  - `crates/ui-components/src/number/mod.rs`
  - `crates/ui-components/src/number/logic.rs`
  - `crates/ui-components/src/number/view.rs`
  - `crates/ui-components/src/number/styles.rs`
  - `crates/ui-components/src/number/motion.rs`
