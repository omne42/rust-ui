...
pub use logic::{DEFAULT_ARIA_LABEL, MenuSectionHeadingTone};
pub use view::MenuSection;

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct MenuSectionStateInput {
    pub heading_tone: MenuSectionHeadingTone,
