...
pub fn attach_motion(
    ...
    Effect::new(move |_| {
        ...
        let _ = style.set_property("--ui-swatch-scale", &format!("{initial_scale}"));
        let _ = style.set_property("--ui-swatch-ring-opacity", &format!("{initial_ring}"));
        ...
        let scale =
            ui_motion::spring::SpringAnimator::new(initial_scale, motion.spring, move |next| {
                ...
                let _ = style_scale.set_property("--ui-swatch-scale", &format!("{next}"));
            });
        ...
        let ring =
            ui_motion::spring::SpringAnimator::new(initial_ring, motion.spring, move |next| {
                ...
                let _ = style_ring.set_property("--ui-swatch-ring-opacity", &format!("{next}"));
            });
