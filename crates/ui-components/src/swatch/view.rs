...
pub fn Swatch(
    ...
    let mixed_label_fallback = common.swatch_mixed_aria_label.to_string();
    let nothing_label_fallback = common.swatch_nothing_aria_label.to_string();
    let default_label_fallback = common.swatch_default_aria_label.to_string();
