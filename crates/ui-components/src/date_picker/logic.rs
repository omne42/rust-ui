use crate::date_picker::{DatePickerState, DatePickerStateInput};
...
pub fn compose_class_name(base_class_name: Option<String>, state: DatePickerState) -> String {
    let mut classes = vec!["ui-date-picker".to_string(), state.tone_class.to_string()];
...
mod tests {
    use super::*;
    use crate::date_picker::DatePickerStateInput;
