...
- Semantic tests: `crates/ui-components/tests/illustrated_message_semantics.rs`.
...
- Source files:
  - `crates/ui-components/src/illustrated_message/mod.rs`
  - `crates/ui-components/src/illustrated_message/logic.rs`
  - `crates/ui-components/src/illustrated_message/view.rs`
  - `crates/ui-components/src/illustrated_message/styles.rs`
  - `crates/ui-components/src/illustrated_message/motion.rs`
