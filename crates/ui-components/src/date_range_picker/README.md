...
- `crates/ui-state-primitives/src/date_range_picker.rs`：`DateRangePickerStateInput`、`DateRangePickerState`、区间有效性与来源标记派生。
...
- CSS Test 区：加载 `crates/ui-components/src/date_range_picker/styles.rs`，用于局部 CSS 契约验证。
