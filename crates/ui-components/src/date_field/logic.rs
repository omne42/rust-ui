use crate::date_field::{DateFieldState, DateFieldStateInput};
...
pub fn compose_class_name(base_class_name: Option<String>, state: DateFieldState) -> String {
    let mut classes = vec!["ui-date-field".to_string(), state.tone_class.to_string()];
...
mod tests {
    use super::*;
    use crate::date_field::DateFieldStateInput;
