...
- Real source files:
  - `crates/ui-components/src/overlay/mod.rs`
  - `crates/ui-components/src/overlay/logic.rs`
  - `crates/ui-components/src/overlay/view.rs`
  - `crates/ui-components/src/overlay/styles.rs`
  - `crates/ui-components/src/overlay/motion.rs`
