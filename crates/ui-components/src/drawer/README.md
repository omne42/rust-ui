...
- 真实源码落点：
  - `crates/ui-components/src/drawer/mod.rs`
  - `crates/ui-components/src/drawer/logic.rs`
  - `crates/ui-components/src/drawer/view.rs`
  - `crates/ui-components/src/drawer/styles.rs`
  - `crates/ui-components/src/drawer/motion.rs`
