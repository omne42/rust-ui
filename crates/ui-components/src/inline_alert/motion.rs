...
fn sanitize_spring(value: ui_motion::spring::SpringConfig) -> ui_motion::spring::SpringConfig {
    let default = InlineAlertMotion::default().spring;
...
mod tests {
    ...
    fn default_motion_matches_inline_alert_spring_contract() {
        let motion = InlineAlertMotion::default();
    ...
    fn sanitize_motion_falls_back_for_invalid_values() {
        let default = InlineAlertMotion::default();

        let motion = sanitize_motion(InlineAlertMotion {
            spring: ui_motion::spring::SpringConfig {
                stiffness: f64::NAN,
                damping: -1.0,
                mass: 0.0,
