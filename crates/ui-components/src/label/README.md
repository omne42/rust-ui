...
- 组件源码入口：
  - `crates/ui-components/src/label/mod.rs`
  - `crates/ui-components/src/label/logic.rs`
  - `crates/ui-components/src/label/view.rs`
  - `crates/ui-components/src/label/styles.rs`
  - `crates/ui-components/src/label/motion.rs`
- 状态原语定义：
