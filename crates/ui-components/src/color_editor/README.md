...
- 组件源码入口：
  - `crates/ui-components/src/color_editor/mod.rs`
  - `crates/ui-components/src/color_editor/logic.rs`
  - `crates/ui-components/src/color_editor/view.rs`
  - `crates/ui-components/src/color_editor/styles.rs`
  - `crates/ui-components/src/color_editor/motion.rs`
- 状态原语定义：
