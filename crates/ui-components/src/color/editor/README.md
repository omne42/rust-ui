...
- 组件源码入口：
  - `crates/ui-components/src/color/editor/mod.rs`
  - `crates/ui-components/src/color/editor/logic.rs`
  - `crates/ui-components/src/color/editor/view.rs`
  - `crates/ui-components/src/color/editor/styles.rs`
  - `crates/ui-components/src/color/editor/motion.rs`
- 状态原语定义：
