...
fn resolve_semantics(
    ...
    label_id: String,
    lang: Option<String>,
    dir: Option<crate::color_area::A11yDirection>,
...
pub fn ColorArea(
    ...
    view! {
        <div
            ...
            data-step=move || root.get().state.step.to_string()
        ...
        >
            ...
            <div class="ui-color-area__axes" data-slot=SLOT_COLOR_AREA_AXES>
                ...
                <input
                    ...
                    min="0"
                    max="100"
                    step=move || (root.get().state.step * 100.0).to_string()
                    prop:value=move || root.get().state.value_x_percent.to_string()
                ...
                <input
                    ...
                    max="100"
                    step=move || (root.get().state.step * 100.0).to_string()
                    prop:value=move || root.get().state.value_y_percent.to_string()
                    disabled=move || root.get().state.is_disabled
                    aria-disabled=move || resolve_semantics(
                        root.get(),
                        label_id_for_semantics.get_value(),
