...
- Workbench 通过 `test_css_source` 加载三段样式契约：
  - `crates/ui-components/src/list/styles.rs::CSS`
  - `crates/ui-components/src/list/styles.rs::ITEM_CSS`
  - `crates/ui-components/src/list/styles.rs::SECTION_CSS`
...
- 组件源码：`crates/ui-components/src/list/{mod,logic,view,styles,motion}.rs`
