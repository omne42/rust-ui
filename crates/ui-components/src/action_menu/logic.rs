...
pub fn normalize_id_base(id_base: String) -> String {
    normalize_optional_text(Some(id_base)).unwrap_or_else(|| "action-menu".to_string())
}
...
pub fn resolve_trigger_aria_label(value: Option<String>) -> (String, bool) {
    ...
    ("More actions".to_string(), false)
}

pub fn resolve_state(input: ActionMenuStateInput) -> ActionMenuState {
    ActionMenuState {
...
pub fn compose_class_name(base_class_name: Option<String>, state: ActionMenuState) -> String {
    let mut classes = vec![
        "ui-action-menu".to_string(),
...
mod tests {
    ...
    fn normalize_id_base_falls_back_when_blank() {
        ...
        assert_eq!(normalize_id_base("   ".to_string()), "action-menu");
    }
    ...
    fn resolve_state_tracks_trigger_items_and_strategy_flags() {
        let state = resolve_state(ActionMenuStateInput {
            item_count: 3,
    ...
    fn compose_class_name_includes_state_markers() {
        let class_name = compose_class_name(
            ...
            resolve_state(ActionMenuStateInput {
                item_count: 0,
        ...
        for token in [
            "ui-action-menu",
            "ui-action-menu--placement-bottom-start",
