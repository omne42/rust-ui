...
fn bottom_sheet_check2_marks_semantic_test_priority_item_complete() {
    ...
    for marker in [
        "crates/ui-components/tests/bottom_sheet_semantics.rs::bottom_sheet_semantic_contract_matrix_covers_interaction_paths_without_snapshot_only_assertions",
        "crates/ui-components/tests/bottom_sheet_semantics.rs::bottom_sheet_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks",
        "crates/ui-components/tests/bottom_sheet_semantics.rs::bottom_sheet_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement",
        "scripts/check-ui-components-performance.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
