...
fn list_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/list_module_semantics.rs::list_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            checklist_source.contains(needle),
...
fn list_styles_use_defensive_variable_fallback_chain_with_ui_theme_ssot_terminals() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/list_module_semantics.rs::list_styles_use_defensive_variable_fallback_chain_with_ui_theme_ssot_terminals",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            checklist_source.contains(needle),
...
fn list_cascade_layer_contract_is_aggregated_in_ui_layer_and_rejects_plain_inline_style_rules() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/list_module_semantics.rs::list_cascade_layer_contract_is_aggregated_in_ui_layer_and_rejects_plain_inline_style_rules",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            checklist_source.contains(needle),
...
fn list_engineering_contract_uses_serde_protocol_and_keeps_tracing_runtime_boundaries() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/list_module_semantics.rs::list_engineering_contract_uses_serde_protocol_and_keeps_tracing_runtime_boundaries",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            checklist_source.contains(needle),
