...
fn sidebar_trigger_does_not_expose_logic_or_view_modules() {
    let source = load_source("src/sidebar/trigger/mod.rs");
...
fn sidebar_trigger_is_exported_from_module_and_crate_root() {
    let module_source = load_source("src/sidebar/trigger/mod.rs");
...
fn sidebar_trigger_uses_logic_state_model() {
    let logic_source = load_source("src/sidebar/trigger/logic.rs");
    let view_source = load_source("src/sidebar/trigger/view.rs");
...
fn sidebar_trigger_supports_controlled_and_uncontrolled_open_state() {
    let source = load_source("src/sidebar/trigger/view.rs");
...
fn sidebar_trigger_styles_include_state_markers() {
    let source = load_source("src/sidebar/trigger/styles.rs");
