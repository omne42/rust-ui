...
fn modal_check2_marks_dx_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/modal_semantics.rs::modal_dx_playground_supports_css_hot_reload_without_wasm_rebuild",
        "crates/ui-components/tests/modal_semantics.rs::modal_dx_interactive_scope_keeps_isolated_canvas_and_context_visible_with_optional_persist_na",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn modal_check2_marks_engineering_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/modal_semantics.rs::modal_engineering_contract_uses_serde_protocol_and_structured_schema_defaults",
        "crates/ui-components/tests/modal_semantics.rs::modal_engineering_contract_keeps_tracing_semantics_unified_without_component_local_events",
        "crates/ui-components/tests/modal_semantics.rs::modal_engineering_contract_avoids_runtime_leaks_in_public_api_surface",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn modal_check2_marks_semantic_test_priority_item_complete() {
    ...
    for marker in [
        ...
        "crates/ui-components/tests/modal_semantics.rs::modal_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks",
        "scripts/check-ui-components-performance.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn modal_check2_marks_e2e_selector_stability_item_complete() {
    ...
    for marker in [
        ...
        "crates/ui-components/tests/modal_semantics.rs::modal_e2e_contract_uses_semantic_selectors_and_stable_waits",
