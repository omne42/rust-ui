...
fn sidebar_header_does_not_expose_logic_or_view_modules() {
    let source = load_source("src/sidebar/header/mod.rs");
...
fn sidebar_header_is_exported_from_module_and_crate_root() {
    let module_source = load_source("src/sidebar/header/mod.rs");
...
fn sidebar_header_uses_logic_state_model() {
    let logic_source = load_source("src/sidebar/header/logic.rs");
    let view_source = load_source("src/sidebar/header/view.rs");
...
fn sidebar_header_emits_baseline_root_state_data_attributes() {
    let source = load_source("src/sidebar/header/view.rs");
...
fn sidebar_header_styles_include_state_markers() {
    let source = load_source("src/sidebar/header/styles.rs");
