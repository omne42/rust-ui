...
fn scroll_area_styles_depend_on_explicit_state_markers_and_runtime_vars_only() {
    ...
    for required in [
        "style=inline_style.get_value().unwrap_or_default()",
        "let inline_style = StoredValue::new(Some(motion::attach_motion(None, motion)));",
        "style.set_property(\"--ui-scroll-area-max-h\",",
...
fn scroll_area_e2e_key_flow_is_repeatable_and_failure_points_are_semantic() {
    ...
    for needle in [
        ...
        "toHaveAttribute(\"data-ui-action\", \"observe\")",
        "toHaveAttribute(\"data-ui-state\", \"enabled\")",
        "toHaveAttribute(\"data-ui-source\", \"legacy-prop\")",
        "toHaveAttribute(\"data-ui-output-status\", \"verified\")",
        "await page.reload();",
...
fn scroll_area_e2e_check_script_covers_selector_and_settled_wait_contracts() {
    let script_source = load_source("../../scripts/check-ui-components-e2e-scroll-area.sh");

    for needle in [
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_check2_documents_e2e_selector_and_stable_wait_rules",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_e2e_selector_contract_uses_semantic_markers_and_stable_waits",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_e2e_ready_and_settled_contract_covers_motion_and_disabled_semantic_breakpoints",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_check2_documents_e2e_repeatable_key_flow_rules",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_e2e_key_flow_is_repeatable_and_failure_points_are_semantic",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_e2e_high_risk_paths_cover_focus_keyboard_and_settled_semantic_breakpoints",
    ] {
        assert!(
            script_source.contains(needle),
...
fn scroll_area_streaming_check_script_covers_llm_two_mode_definition_contract() {
    ...
    let needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_check2_documents_streaming_definition_is_llm_output_only_with_two_modes";
    assert!(
        script_source.contains(needle),
...
fn scroll_area_streaming_check_script_covers_snapshot_baseline_contract() {
    ...
    for needle in [
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_check2_documents_snapshot_as_default_baseline_capability",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_snapshot_baseline_consumes_complete_result_and_renders_stably",
    ] {
        assert!(
            script_source.contains(needle),
            "streaming check script should enforce `{needle}`."
...
fn scroll_area_streaming_check_script_covers_streaming_responsibility_contract() {
    ...
    for needle in [
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_check2_documents_streaming_required_optional_classification_rules",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_streaming_optional_scope_keeps_role_aria_and_data_markers_continuous",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_streaming_validation_retry_resilience_boundaries_stay_outside_component_layer",
    ] {
        assert!(
            script_source.contains(needle),
            "streaming check script should enforce `{needle}`."
...
fn scroll_area_token_first_static_style_contract_is_enforced() {
    ...
    for required in [
        ...
        assert!(
            ...
            "ui-components/css.rs should aggregate scroll_area CSS via feature gate `{required}`."
        );
    }
...
fn scroll_area_performance_governance_budget_is_defined_and_blocking() {
    ...
    let script_needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_performance_governance_budget_is_defined_and_blocking";
    assert!(
...
fn scroll_area_view_macro_complexity_is_small_and_does_not_require_semantic_subrenders() {
    ...
    let script_needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_view_macro_complexity_is_small_and_does_not_require_semantic_subrenders";
    assert!(
        script_source.contains(script_needle),
...
fn scroll_area_view_functional_split_prefers_no_extra_local_components_for_simple_layout() {
    ...
    let script_needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_view_functional_split_prefers_no_extra_local_components_for_simple_layout";
    assert!(
        script_source.contains(script_needle),
        "view-macro gate script should include `{script_needle}`."
    );
...
fn scroll_area_static_fragments_are_constantized_or_absent_for_simple_layout() {
    ...
    let script_needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_static_fragments_are_constantized_or_absent_for_simple_layout";
    assert!(
        script_source.contains(script_needle),
        "view-macro gate script should include `{script_needle}`."
    );
...
fn scroll_area_inner_html_check_script_covers_security_contract() {
    ...
    let needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_inner_html_usage_is_explicitly_na_and_guarded";
    assert!(
        script_source.contains(needle),
...
fn scroll_area_wasm_debug_check_script_covers_shared_contract() {
    ...
    let needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated";
    assert!(
        script_source.contains(needle),
...
fn scroll_area_dx_check_script_covers_hot_reload_and_isolated_canvas_contract() {
    ...
    for needle in [
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_dx_playground_supports_css_hot_reload_without_wasm_rebuild",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_dx_interactive_scope_keeps_isolated_canvas_and_context_visible_with_optional_persist_na",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_docs_app_provides_interactive_playground_for_props_state_and_preview",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_interactive_playground_reuses_repeatable_semantic_e2e_flow",
    ] {
        assert!(
            script_source.contains(needle),
...
fn scroll_area_engineering_contract_keeps_tracing_semantics_unified_without_component_local_events()
{
    ...
    for forbidden in [
        ...
        "tracing::event!(",
        "#[tracing::instrument]",
        "target: \"ui_components::scroll_area::",
...
fn scroll_area_engineering_check_script_covers_serde_tracing_and_runtime_boundaries() {
    ...
    for needle in [
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_engineering_contract_marks_spec_serde_path_as_na_for_simple_component_scope",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_engineering_contract_keeps_tracing_semantics_unified_without_component_local_events",
        "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_engineering_contract_avoids_runtime_leaks_in_public_api_surface",
    ] {
        assert!(
            script_source.contains(needle),
...
#[test]
fn scroll_area_ui_components_fixed_entry_files_follow_layered_boundaries() {
    let manifest_dir = Path::new(env!("CARGO_MANIFEST_DIR"));
    let lib_source = load_source("src/lib.rs");
    let css_source = load_source("src/css.rs");
    let root_source = load_source("src/root.rs");
    ...
    for forbidden in [
        ...
        assert!(
            ...
            "ui-components lib entry should not expose internal/detail marker `{forbidden}`."
        );
    }
...
fn scroll_area_entrypoints_check_script_covers_fixed_entrypoint_contract() {
    ...
    let needle = "cargo test -p ui-components --test scroll_area_semantics --no-default-features --features component-scroll_area,inject-css scroll_area_ui_components_fixed_entry_files_follow_layered_boundaries";
    assert!(
        script_source.contains(needle),
...
fn scroll_area_docs_examples_sync_with_logic_api_names_and_state_matrix() {
    ...
    for needle in [
        ...
        "is_disabled: Option<bool> + disabled: bool",
...
fn scroll_area_docs_are_copy_paste_ready_with_imports_copy_button_and_sync() {
    ...
    for needle in [
        ...
        "\"crates/ui-components/src/scroll_area/logic.rs\"",
        "\"crates/ui-components/src/scroll_area/view.rs\"",
        "\"crates/ui-components/src/scroll_area/styles.rs\"",
        "\"crates/ui-components/src/scroll_area/motion.rs\"",
...
fn scroll_area_check2_marks_source_first_copy_paste_ready_complete() {
    ...
    for needle in [
        ...
        "文档代码与当前实现必须同步，防止示例漂移。",
        "component-scroll_area",
        "crates/ui-components/src/scroll_area/{mod,logic,view,styles,motion}.rs",
