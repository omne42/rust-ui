...
fn sidebar_footer_does_not_expose_logic_or_view_modules() {
    let source = load_source("../../components/sidebar/src/footer/mod.rs");
...
fn sidebar_footer_is_exported_from_module_and_crate_root() {
    let module_source = load_source("../../components/sidebar/src/footer/mod.rs");
...
fn sidebar_footer_uses_logic_state_model() {
    let logic_source = load_source("../../components/sidebar/src/footer/logic.rs");
    let view_source = load_source("../../components/sidebar/src/footer/view.rs");
...
fn sidebar_footer_emits_baseline_root_state_data_attributes() {
    let source = load_source("../../components/sidebar/src/footer/view.rs");
...
fn sidebar_footer_styles_include_state_markers() {
    let source = load_source("../../components/sidebar/src/footer/styles.rs");
