...
fn circular_progress_semantic_contract_test_suite_prioritizes_contract_markers_over_visual_snapshots()
 {
    let workspace_semantics_source =
        load_ui_components_source("tests/circular_progress_semantics.rs");
...
fn circular_progress_check2_marks_e2e_selector_stability_item_complete() {
    ...
    for needle in [
        "crates/ui-components/tests/circular_progress_semantics.rs::circular_progress_check2_documents_e2e_selector_and_stable_wait_rules",
        "crates/ui-components/tests/circular_progress_semantics.rs::circular_progress_e2e_selector_contract_uses_semantic_markers_and_settled_waits",
        "crates/ui-components/tests/circular_progress_semantics.rs::circular_progress_e2e_contract_covers_ready_and_settled_semantic_breakpoints",
...
fn circular_progress_check2_marks_key_flow_regression_collection_complete() {
    ...
    for needle in [
        "crates/ui-components/tests/circular_progress_semantics.rs::circular_progress_check2_documents_key_flow_regression_collection_rules",
        "crates/ui-components/tests/circular_progress_semantics.rs::circular_progress_e2e_key_flow_regression_is_repeatable_and_breakpoint_diagnosable",
        "crates/ui-components/tests/circular_progress_semantics.rs::circular_progress_e2e_check_script_covers_key_flow_regression_contract",
