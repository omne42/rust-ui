...
fn drawer_tree_shaking_contract_is_feature_gated_and_budget_guarded() {
    ...
    for needle in [
        ...
        "回归：`crates/ui-components/tests/drawer_semantics.rs::drawer_tree_shaking_contract_is_feature_gated_and_budget_guarded`",
    ] {
        assert!(
...
fn drawer_type_system_and_semantic_markers_form_machine_readable_contract() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/drawer_semantics.rs::drawer_type_system_and_semantic_markers_form_machine_readable_contract",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_focus_stack_gc_contract_uses_global_focus_manager_and_policy_restore() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/drawer_semantics.rs::drawer_focus_stack_gc_contract_uses_global_focus_manager_and_policy_restore",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_escape_hatches_foreign_zone_contract_is_not_applicable() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/drawer_semantics.rs::drawer_escape_hatches_foreign_zone_contract_is_not_applicable",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_hydration_discontinuity_contract_is_n_a_without_time_or_random_id_init() {
    ...
    for needle in [
        ...
        "crates/ui-components/src/root.rs",
        "provide_ui_id_provider(id_seed)",
        "crates/ui-components/tests/drawer_semantics.rs::drawer_hydration_discontinuity_contract_is_n_a_without_time_or_random_id_init",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_ssr_and_cross_platform_compile_contract_is_documented_and_non_wasm_safe() {
    ...
    for needle in [
        ...
        "components/sheet/src/view.rs",
        "crates/ui-components/tests/drawer_semantics.rs::drawer_ssr_and_cross_platform_compile_contract_is_documented_and_non_wasm_safe",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_headless_web_ssr_mutex_guard_is_preserved() {
    ...
    for needle in [
        ...
        "cargo check -p ui-headless --no-default-features --features web,ssr",
        "mutually exclusive",
        "crates/ui-components/tests/drawer_semantics.rs::drawer_headless_web_ssr_mutex_guard_is_preserved",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_ui_motion_non_wasm_stub_contract_is_predictable_and_tooling_safe() {
    ...
    for needle in [
        ...
        "components/sheet/src/motion.rs",
        "cargo test -p ui-motion --test non_wasm_stub",
        "crates/ui-components/tests/drawer_semantics.rs::drawer_ui_motion_non_wasm_stub_contract_is_predictable_and_tooling_safe",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_reduced_motion_ssr_wasm_branches_keep_semantics_consistent() {
    ...
    for needle in [
        ...
        "if reduced_motion",
        "finish_exit.run(())",
        "crates/ui-components/tests/drawer_semantics.rs::drawer_reduced_motion_ssr_wasm_branches_keep_semantics_consistent",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement()
{
    ...
    let aggregated_semantics = load_source("tests/drawer_semantics.rs");
    let drawer_view_source = load_source("src/drawer/view.rs");
    let sheet_view_source = load_source("../../components/sheet/src/view.rs");
