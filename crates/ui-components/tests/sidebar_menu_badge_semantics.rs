...
fn sidebar_menu_badge_does_not_expose_logic_or_view_modules() {
    let source = load_source("../../components/sidebar/src/menu_badge/mod.rs");
...
fn sidebar_menu_badge_is_exported_from_module_and_crate_root() {
    let module_source = load_source("../../components/sidebar/src/menu_badge/mod.rs");
...
fn sidebar_menu_badge_uses_logic_state_model() {
    let logic_source = load_source("../../components/sidebar/src/menu_badge/logic.rs");
    let view_source = load_source("../../components/sidebar/src/menu_badge/view.rs");
...
fn sidebar_menu_badge_emits_baseline_root_state_data_attributes() {
    let source = load_source("../../components/sidebar/src/menu_badge/view.rs");
...
fn sidebar_menu_badge_styles_include_state_markers() {
    let source = load_source("../../components/sidebar/src/menu_badge/styles.rs");
