...
fn sidebar_inset_does_not_expose_logic_or_view_modules() {
    let source = load_source("../../components/sidebar/src/inset/mod.rs");
...
fn sidebar_inset_is_exported_from_module_and_crate_root() {
    let module_source = load_source("../../components/sidebar/src/inset/mod.rs");
...
fn sidebar_inset_uses_logic_state_model() {
    let logic_source = load_source("../../components/sidebar/src/inset/logic.rs");
    let view_source = load_source("../../components/sidebar/src/inset/view.rs");
...
fn sidebar_inset_emits_baseline_root_state_data_attributes() {
    let source = load_source("../../components/sidebar/src/inset/view.rs");
...
fn sidebar_inset_styles_include_state_markers() {
    let source = load_source("../../components/sidebar/src/inset/styles.rs");
