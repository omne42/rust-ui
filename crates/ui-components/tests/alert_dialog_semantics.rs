...
fn alert_dialog_check2_marks_type_system_and_semantic_marker_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_semantics_matrix_covers_control_disabled_and_input_paths",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_motion_contractualization_complete() {
    ...
    for source in [check2_root, check2_src] {
        ...
        for needle in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_motion_contract_is_component_scoped_reduced_motion_aware_and_non_wasm_safe",
            "Invalid cross-device link (os error 18)",
        ] {
            assert!(
                source.contains(needle),
...
fn alert_dialog_check2_marks_ui_components_fixed_entry_files_complete() {
    ...
    for source in [check2_root, check2_src] {
        for required in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_ui_components_fixed_entry_files_follow_layered_boundaries",
...
fn alert_dialog_check2_marks_component_directory_standard_files_complete() {
    ...
    for source in [check2_root, check2_src] {
        for required in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_component_directory_has_standard_file_layout",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_mod_rs_keeps_minimal_stable_exports",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_component_file_responsibilities_remain_scoped",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_spec_file_is_not_introduced_for_simple_component",
...
fn alert_dialog_check2_marks_file_placement_discipline_contract_complete() {
    ...
    for source in [check2_root, check2_src] {
        ...
        for required in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_file_placement_discipline_is_strict_for_component_scope",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_file_placement_check_script_covers_contract",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_check2_marks_file_placement_discipline_contract_complete",
            "scripts/check-ui-components-component-files.sh",
...
fn alert_dialog_check2_marks_hyper_structure_builder_item_complete() {
    ...
    for source in [check2_root, check2_src] {
        ...
        for required in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_hyper_structure_builder_spec_is_not_applicable_for_simple_component",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_hyper_structure_builder_check_script_covers_contract",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_check2_marks_hyper_structure_builder_item_complete",
            "scripts/check-ui-components-component-files.sh",
...
fn alert_dialog_check2_marks_context_compression_item_complete() {
    ...
    for source in [check2_root, check2_src] {
        ...
        for required in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_context_compression_manifest_and_rbi_projection_are_present_and_current",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_context_compression_check_script_covers_contract",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_check2_marks_context_compression_item_complete",
            "scripts/check-ui-components-component-files.sh",
...
fn alert_dialog_check2_marks_agent_contract_schema_governance_complete() {
    ...
    for source in [check2_root, check2_src] {
        for needle in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_check2_documents_agent_contract_schema_governance_rules",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_agent_contract_is_schema_typed_and_machine_readable",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_agent_contract_fields_are_type_derived_without_free_form_schema_string_splicing",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_agent_contract_render_path_is_whitelist_safe_and_script_injection_free",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_contract_hygiene_script_covers_agent_contract_schema_guards",
            "scripts/check-ui-components-contract-hygiene.sh",
            "Invalid cross-device link (os error 18)",
        ] {
            assert!(
...
fn alert_dialog_check2_marks_streaming_two_mode_definition_complete() {
    ...
    for source in [check2_root, check2_src] {
        ...
        for needle in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_check2_documents_streaming_definition_is_llm_output_only_with_two_modes",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_streaming_script_covers_two_mode_definition_contract",
...
fn alert_dialog_check2_marks_snapshot_baseline_capability_complete() {
    ...
    for source in [check2_root, check2_src] {
        for needle in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_check2_documents_snapshot_as_default_baseline_capability",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_snapshot_baseline_consumes_complete_result_and_renders_stably",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_streaming_script_covers_snapshot_baseline_contract",
            "scripts/check-ui-components-streaming.sh",
            "Invalid cross-device link (os error 18)",
        ] {
            assert!(
...
fn alert_dialog_check2_marks_streaming_required_optional_classification_complete() {
    ...
    for source in [check2_root, check2_src] {
        for needle in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_check2_documents_streaming_required_optional_classification_rules",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_streaming_optional_scope_keeps_role_aria_and_data_markers_continuous",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_streaming_validation_retry_resilience_boundaries_stay_outside_component_layer",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_streaming_script_covers_required_optional_classification_contract",
            "scripts/check-ui-components-streaming.sh",
            "Invalid cross-device link (os error 18)",
        ] {
            assert!(
...
fn alert_dialog_check2_marks_rust_hygiene_contract_complete() {
    ...
    for source in [check2_root, check2_src] {
        for needle in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_rust_hygiene_contract_forbids_unwrap_expect_and_let_underscore_in_non_test_sources",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_rust_hygiene_string_clone_hotspots_converge_to_cow_or_are_absent",
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_rust_hygiene_script_enforces_repo_level_hygiene_guards",
...
fn alert_dialog_check2_marks_escape_hatch_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_escape_hatch_foreign_zone_contract_is_na_and_non_polluting",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_hydration_discontinuity_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_hydration_discontinuity_contract_is_explicitly_na_without_entropy_init",
        "provide_ui_id_provider(id_seed)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_reduced_motion_ssr_wasm_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_reduced_motion_ssr_wasm_branches_keep_semantics_consistent",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_performance_governance_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_performance_governance_budget_is_defined_and_blocking",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_semantic_test_priority_item_complete() {
    ...
    for source in [check2_root, check2_src] {
        ...
        for marker in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks",
            "scripts/check-ui-components-performance.sh",
            "Invalid cross-device link (os error 18)",
        ] {
            assert!(
...
fn alert_dialog_check2_marks_view_macro_complexity_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_view_macro_complexity_is_split_into_semantic_subrenders",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_view_functional_split_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_view_functional_split_prefers_plain_functions_over_local_components",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_static_fragment_constantization_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_static_fragments_are_constantized_with_templated_type_icons",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_inner_html_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_inner_html_usage_is_forbidden_in_component_and_docs_examples",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_wasm_debug_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_wasm_debug_contract_reuses_global_debug_trace_and_keeps_feature_isolated",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_dx_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_dx_playground_supports_css_hot_reload_without_wasm_rebuild",
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_dx_interactive_scope_keeps_isolated_canvas_and_context_visible_with_optional_persist_na",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn alert_dialog_check2_marks_engineering_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_engineering_contract_uses_serde_protocol_and_structured_schema_defaults",
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_engineering_contract_keeps_tracing_semantics_unified_without_component_local_events",
        "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_engineering_contract_avoids_runtime_leaks_in_public_api_surface",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
