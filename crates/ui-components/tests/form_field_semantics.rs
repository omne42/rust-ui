...
fn form_field_ui_components_fixed_entry_files_follow_layered_boundaries() {
    let ui_components_lib = load_source("src/lib.rs");
    let ui_components_field_form = load_source("src/field_form.rs");
...
fn form_field_component_directory_standard_files_follow_contract_and_na_paths() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_component_directory_standard_files_follow_contract_and_na_paths",
...
fn form_field_file_placement_discipline_is_strict_for_component_scope() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_file_placement_discipline_is_strict_for_component_scope",
        "scripts/check-ui-components-component-files.sh",
    ] {
        assert!(
            local_semantics.contains(required) || check2_source.contains(required),
...
fn form_field_hyper_structure_builder_spec_is_not_applicable_for_simple_component() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_hyper_structure_builder_spec_is_not_applicable_for_simple_component",
        "scripts/check-ui-components-component-files.sh",
    ] {
        assert!(
            local_semantics.contains(required) || check2_source.contains(required),
...
fn form_field_context_compression_manifest_and_rbi_projection_are_present_and_synced() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_context_compression_manifest_and_rbi_projection_are_present_and_synced",
        "scripts/check-ui-components-component-files.sh",
    ] {
        assert!(
            local_semantics.contains(required) || check2_source.contains(required),
...
fn form_field_check2_documents_streaming_definition_is_llm_output_only_with_two_modes() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_streaming_definition_is_llm_output_only_with_two_modes",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn form_field_check2_documents_snapshot_as_default_baseline_capability() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_snapshot_as_default_baseline_capability",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn form_field_check2_documents_streaming_required_optional_classification_rules() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_streaming_required_optional_classification_rules",
    ] {
        assert!(
            check2_source.contains(needle),
