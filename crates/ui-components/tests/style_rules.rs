...
fn style_equals_is_only_used_in_approved_files() {
    ...
    let allowed_paths: HashSet<PathBuf> = [
        ...
        PathBuf::from("src/color_area/view.rs"),
        PathBuf::from("src/color_handle/view.rs"),
        PathBuf::from("src/color_slider/view.rs"),
        PathBuf::from("src/color_swatch/view.rs"),
        PathBuf::from("src/combo_box/view.rs"),
        PathBuf::from("src/fieldset/view.rs"),
        ...
        PathBuf::from("src/text_area/view.rs"),
        PathBuf::from("src/text_field/view.rs"),
        PathBuf::from("src/textarea/view.rs"),
