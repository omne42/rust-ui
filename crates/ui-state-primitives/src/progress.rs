...
impl ProgressMode {
    ...
    pub fn is_indeterminate(self) -> bool {
        matches!(self, ProgressMode::Indeterminate)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct ProgressValueAxisInput {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct ProgressValueAxisState {
    pub is_controlled: bool,
    pub has_default_value: bool,
    pub has_on_value_change: bool,
...
pub fn resolve_value_axis(input: ProgressValueAxisInput) -> ProgressValueAxisState {
