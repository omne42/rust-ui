...
pub enum ProgressCircleMode {
    #[default]
    Auto,
    Indeterminate,
}

impl ProgressCircleMode {
    pub fn as_str(self) -> &'static str {
        match self {
            ProgressCircleMode::Auto => "auto",
            ProgressCircleMode::Indeterminate => "indeterminate",
        }
    }

    pub fn is_indeterminate(self) -> bool {
        matches!(self, ProgressCircleMode::Indeterminate)
    }
}

pub fn normalize_mode(is_indeterminate: bool) -> ProgressCircleMode {
    if is_indeterminate {
        ProgressCircleMode::Indeterminate
    } else {
        ProgressCircleMode::Auto
    }
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct ProgressCircleValueAxisInput {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct ProgressCircleValueAxisState {
    pub is_controlled: bool,
    pub has_default_value: bool,
    pub has_on_value_change: bool,
...
pub fn resolve_value_axis(input: ProgressCircleValueAxisInput) -> ProgressCircleValueAxisState {
