...
fn load_source(rel_path: &str) -> String {
    if rel_path == "../../apps/docs-app/src/pages/components/pages/layout_extra.rs" {
        let manifest_dir = Path::new(env!("CARGO_MANIFEST_DIR"));
        let parent_path =
            manifest_dir.join("../../apps/docs-app/src/pages/components/pages/layout_extra.rs");
        let child_path = manifest_dir
            .join("../../apps/docs-app/src/pages/components/pages/layout_extra/surface.rs");
...
fn surface_semantics_suite_prioritizes_contract_assertions_over_snapshots() {
    let source = load_source("tests/surface/semantics.rs");
...
fn surface_semantic_contract_markers_in_view_are_backed_by_semantics_suite_assertions() {
    let view_source = load_source("src/surface/view.rs");
    let semantics_test_source = load_source("tests/surface/semantics.rs");
