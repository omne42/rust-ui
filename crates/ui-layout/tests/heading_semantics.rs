...
fn load_source(rel_path: &str) -> String {
    if rel_path == "../../apps/docs-app/src/pages/components/pages/layout.rs" {
        ...
        let child_path =
            manifest_dir.join("../../apps/docs-app/src/pages/components/pages/layout/heading.rs");
...
#[test]
fn heading_emits_baseline_style_state_data_attributes() {
    ...
    for attr in [
        ...
        assert!(
            ...
            "Heading should expose `{attr}` for baseline-style styling and state inspection."
        );
    }
}
