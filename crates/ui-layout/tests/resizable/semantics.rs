...
fn load_source(rel_path: &str) -> String {
    if rel_path == "../../apps/docs-app/src/pages/components/pages/layout_extra.rs" {
        ...
        let child_path = manifest_dir
            .join("../../apps/docs-app/src/pages/components/pages/layout_extra/resizable.rs");
...
fn resizable_semantic_checks_are_contract_first_and_snapshot_secondary() {
    ...
    let suite_source = load_source("tests/resizable/semantics.rs");
    let view_source = load_source("src/resizable/view.rs");
