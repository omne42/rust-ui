...
#### 10.1 门禁与验证命令（逐条执行）
- [x] `TMPDIR=/root/autodl-tmp/tmp CARGO_TARGET_DIR=/root/autodl-tmp/cargo-target/keyboard-check cargo check -p ui --no-default-features --features component-keyboard,inject-css`
- [x] `TMPDIR=/root/autodl-tmp/tmp CARGO_TARGET_DIR=/root/autodl-tmp/cargo-target/keyboard-check cargo check -p ui --target wasm32-unknown-unknown --no-default-features --features component-keyboard,inject-css`
- [x] `TMPDIR=/root/autodl-tmp/tmp CARGO_TARGET_DIR=/root/autodl-tmp/cargo-target/keyboard-check cargo clippy -p ui --no-default-features --features component-keyboard,inject-css --test keyboard_semantics --no-deps -- -D warnings`
- [x] `TMPDIR=/root/autodl-tmp/tmp CARGO_TARGET_DIR=/root/autodl-tmp/cargo-target/keyboard-check cargo test -p ui --no-default-features --features component-keyboard,inject-css --test keyboard_semantics`
- [x] `TMPDIR=/root/autodl-tmp/tmp CARGO_TARGET_DIR=/root/autodl-tmp/cargo-target/keyboard-check cargo test -p ui --no-default-features --features component-keyboard,inject-css --test keyboard_semantics <single-test> -- --exact`（6 条语义测试逐条执行，全部通过）
- [x] `cargo tree -e features -i ui -p ui --no-default-features --features component-keyboard,inject-css`
