...
fn load_source(path: &str) -> &'static str {
    match path {
        ...
        "workspace_native_select_semantics" => {
            include_str!("../../../components/native-select/test/native_select/semantics.rs")
        }
...
fn native_select_checklist_tracks_ui_components_contract() {
    ...
    assert!(
        check2.contains("native_select_docs_matrix_and_api_contract_are_synced_with_logic_defaults")
            && check2.contains("components/native-select/test/native_select/semantics.rs::native_select_docs_matrix_and_api_contract_are_synced_with_logic_defaults"),
    ...
    assert!(
        check2.contains("native_select_readme_is_beginner_friendly_documentation_product")
            && check2.contains("components/native-select/test/native_select/semantics.rs::native_select_readme_is_beginner_friendly_documentation_product"),
