...
- `rustfmt crates/ui-state-primitives/src/error_view.rs components/error-view/src/logic.rs components/error-view/src/view.rs crates/ui-components/tests/error_view_semantics.rs apps/docs-app/src/pages/components/pages/display_extra.rs`
