...
- `rustfmt crates/ui-state-primitives/src/error_view.rs components/error-view/src/logic.rs components/error-view/src/view.rs components/error-view/test/error_view_semantics.rs apps/docs-app/src/pages/components/pages/display_extra.rs`
