...
fn semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks() {
    ...
    let workspace_semantics_source =
        include_str!("../../../../crates/ui-components/tests/alert_dialog_semantics.rs");
...
fn check2_marks_e2e_selector_stability_item_complete() {
    ...
    for source in [check2_src, check2_root] {
        ...
        for marker in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_e2e_selector_contract_uses_semantic_markers_and_settled_waits",
...
fn check2_marks_e2e_repeatable_key_flow_item_complete() {
    ...
    for source in [check2_src, check2_root] {
        ...
        for marker in [
            ...
            "crates/ui-components/tests/alert_dialog_semantics.rs::alert_dialog_e2e_key_flow_is_repeatable_and_failure_points_are_semantic",
            "scripts/check-ui-components-e2e-alert-dialog.sh",
            "Invalid cross-device link (os error 18)",
        ] {
            assert!(
