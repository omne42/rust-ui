...
fn circular_progress_check2_marks_e2e_selector_stability_item_complete() {
    ...
    for needle in [
        "components/circular-progress/test/circular_progress_semantics.rs::circular_progress_check2_documents_e2e_selector_and_stable_wait_rules",
...
fn circular_progress_check2_marks_key_flow_regression_collection_complete() {
    ...
    for needle in [
        "components/circular-progress/test/circular_progress_semantics.rs::circular_progress_check2_documents_key_flow_regression_collection_rules",
