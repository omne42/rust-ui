...
fn preview_card_is_exported_from_crate_root() {
    ...
    assert!(
        source.contains("pub use ui_preview_card as preview_card;"),
...
fn preview_card_motion_contract_exposes_default_and_customization_checks() {
...
fn preview_card_css_is_aggregated() {
    ...
    assert!(
        ...
        "ui css aggregator should include preview_card styles."
    );
}
