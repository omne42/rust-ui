...
fn selection_indicator_check2_includes_semantic_contract_testing_rules() {
    ...
    for needle in [
        ...
        "回归测试集中在 `components/selection-indicator/test/selection_indicator_module_semantics.rs`",
...
fn selection_indicator_check2_includes_machine_readable_type_marker_rules() {
    ...
    for needle in [
        ...
        "并由 `components/selection-indicator/test/selection_indicator_module_semantics.rs` 持续断言。",
    ] {
        assert!(
            check2.contains(needle),
...
fn selection_indicator_check2_includes_inner_html_safety_rules() {
    ...
    for needle in [
        ...
        "语义回归由 `components/selection-indicator/test/selection_indicator_module_semantics.rs` 持续断言",
