...
use crate::toast::{
    logic, motion, ToastMotion, ToastPartStateInput, ToastSlot, ToastStore, ToastStoreOptions,
    ToastStoreSource, ToastViewportSlot, ToastViewportStateInput,
};
use crate::OnPress;
use leptos::{html, portal::Portal, prelude::*};
use ui_headless::{
    locale_attrs, use_controllable_open_state_traced, use_toast_a11y, use_ui_i18n, A11yDirection,
    CommonStrings, LiveRegionPriority, ToastA11yOptions,
};
...
pub fn Toast(
    ...
    let live_region_priority = if matches!(variant, crate::toast::ToastVariant::Danger) {
    ...
    let toast_a11y = use_toast_a11y(ToastA11yOptions {
        ...
        dir,
        on_dismiss_request: close_toast.clone(),
    });
