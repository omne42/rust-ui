...
- 进阶控制：按需启用 `open/on_open_change/default_open`、`close_on_action`、`is_disabled`
...
- 组件源码：`components/command-dialog/src/{mod,logic,motion,styles,view}.rs`
- 状态/交互原语：`ui_state_primitives::overlay_trigger`、`ui_headless::use_presence`
