...
fn hover_card_semantics_suite_is_contract_first_not_snapshot_only_locally() {
    let view_source = load_source("src/view.rs");
    let semantics_source = load_source("test/semantics.rs");
    let aggregated_source = load_source("../../components/hover-card/test/hover_card/semantics.rs");
...
fn hover_card_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement_locally()
 {
    ...
    let aggregated_semantics =
        load_source("../../components/hover-card/test/hover_card/semantics.rs");
    let view_source = load_source("src/view.rs");
    let headless_hover_source = load_source("../../crates/ui-headless/src/hover_card.rs");
    let todo_source = load_source("../../docs/plan/TODO.md");
...
fn hover_card_view_macro_complexity_is_split_into_semantic_subrenders_locally() {
    ...
    for needle in [
        ...
        "components/hover-card/test/hover_card/semantics.rs::hover_card_view_macro_complexity_is_split_into_semantic_subrenders",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn hover_card_static_fragments_are_constantized_or_absent_for_simple_layout_locally() {
    ...
    for needle in [
        ...
        "components/hover-card/test/hover_card/semantics.rs::hover_card_static_fragments_are_constantized_or_absent_for_simple_layout",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn hover_card_inner_html_usage_is_explicitly_na_and_guarded_locally() {
    ...
    for needle in [
        ...
        "components/hover-card/test/hover_card/semantics.rs::hover_card_inner_html_usage_is_explicitly_na_and_guarded",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn hover_card_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated_locally() {
    ...
    for needle in [
        ...
        "components/hover-card/test/hover_card/semantics.rs::hover_card_wasm_debug_contract_reuses_global_trace_and_stays_feature_isolated",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn hover_card_e2e_check_script_covers_selector_and_settled_wait_contract_locally() {
    let script_source =
        load_source("../../components/hover-card/scripts/check-ui-e2e-hover-card.sh");
