...
- 已新增回归测试锁定修复：`components/checkbox-field/test/checkbox_field/semantics.rs` 增加 `checkbox_field_minimal_feature_gate_keeps_checkbox_dependency_wired`，防止后续再次破坏特性依赖与模块导入路径。
