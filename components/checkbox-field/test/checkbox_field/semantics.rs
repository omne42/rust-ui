...
fn checkbox_field_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement()
 {
    ...
    let aggregated_semantics = load_source("tests/checkbox_field/semantics.rs");
    let view_source = load_source("src/checkbox_field/view.rs");
...
fn checkbox_field_check2_marks_semantics_and_performance_regression_contract_complete() {
    ...
    for marker in [
        ...
        "components/checkbox-field/test/checkbox_field/semantics.rs::checkbox_field_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement",
...
fn checkbox_field_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks()
 {
    ...
    let semantics_source = load_source("tests/checkbox_field/semantics.rs");
...
fn checkbox_field_check2_documents_e2e_selector_and_stable_wait_rules() {
    ...
    for needle in [
        ...
        "components/checkbox-field/test/checkbox_field/semantics.rs::checkbox_field_check2_documents_e2e_selector_and_stable_wait_rules",
        "components/checkbox-field/test/checkbox_field/semantics.rs::checkbox_field_e2e_selector_contract_uses_semantic_markers_and_settled_waits",
        "components/checkbox-field/test/checkbox_field/semantics.rs::checkbox_field_e2e_contract_covers_ready_and_settled_conditions_for_checkbox_field_paths",
