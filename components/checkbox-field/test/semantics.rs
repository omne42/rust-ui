...
fn checkbox_field_check2_marks_documentation_as_product_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_check2_documents_documentation_as_product_rules",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_documentation_entry_exists_with_beginner_first_progression",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_dx_check_script_covers_documentation_as_product_contract",
        "scripts/check-ui-components-dx.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn checkbox_field_check2_marks_interactive_playground_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_check2_documents_interactive_playground_rules",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_docs_app_provides_interactive_playground_for_props_state_and_preview",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_interactive_playground_reuses_repeatable_semantic_e2e_flow",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_dx_check_script_covers_interactive_playground_contract",
        "scripts/check-ui-components-dx.sh",
...
fn checkbox_field_check2_marks_source_first_copy_paste_ready_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_check2_documents_source_first_copy_paste_ready_rules",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_docs_source_first_copy_paste_ready_with_real_paths_and_dependencies",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_dx_check_script_covers_source_first_copy_paste_ready_contract",
        "scripts/check-ui-components-dx.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn checkbox_field_check2_marks_heroui_benchmark_docs_sync_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_check2_documents_heroui_benchmark_docs_sync_rules",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_heroui_strategy_and_component_docs_are_synchronized_and_indexable",
        "crates/ui-components/tests/checkbox_field_semantics.rs::checkbox_field_dx_check_script_covers_heroui_benchmark_docs_sync_contract",
