...
- docs/readme 与 playground：`components/coachmark/src/README.md` 新增 `display/config/code/css test` 分区；`apps/docs-app/src/pages/components/pages/overlays_extra_coachmark.rs` 增补 Display 对比与 Config+Code+CSS Test workbench。
