...
fn form_field_check2_documents_streaming_definition_is_llm_output_only_with_two_modes() {
    ...
    for needle in [
        ...
        "components/form-field/test/form_field_semantics.rs::form_field_check2_documents_streaming_definition_is_llm_output_only_with_two_modes",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn form_field_check2_documents_snapshot_as_default_baseline_capability() {
    ...
    for needle in [
        ...
        "components/form-field/test/form_field_semantics.rs::form_field_check2_documents_snapshot_as_default_baseline_capability",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn form_field_check2_documents_streaming_required_optional_classification_rules() {
    ...
    for needle in [
        ...
        "components/form-field/test/form_field_semantics.rs::form_field_check2_documents_streaming_required_optional_classification_rules",
    ] {
        assert!(
            check2_source.contains(needle),
