...
fn form_field_component_keeps_ui_components_layering_boundaries() {
    ...
    for required in [
        ...
        assert!(
            ...
            "form-field module should keep ui-components layering boundary `{required}`."
        );
    }
...
fn form_field_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot() {
    ...
    let dx_script_source =
        std::fs::read_to_string(component_dir.join("../../scripts/check-ui-components-dx.sh"))
    ...
    let dx_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot";
    assert!(
...
fn form_field_check2_marks_docs_sync_and_state_matrix_item_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_docs_sync_and_state_matrix_rules",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_docs_examples_and_state_matrix_sync_with_logic_api_names_and_defaults",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_dx_check_script_covers_docs_sync_and_state_matrix_contract",
...
fn form_field_check2_marks_documentation_as_product_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_documentation_as_product_rules",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_documentation_entry_exists_with_beginner_first_progression",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_dx_check_script_covers_documentation_as_product_contract",
        "scripts/check-ui-components-dx.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn form_field_check2_marks_interactive_playground_item_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_interactive_playground_rules",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_docs_app_provides_interactive_playground_for_props_state_and_preview",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_interactive_playground_reuses_repeatable_semantic_e2e_flow",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_dx_check_script_covers_interactive_playground_contract",
        "scripts/check-ui-components-dx.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn form_field_check2_marks_source_first_copy_paste_ready_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_source_first_copy_paste_ready_rules",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_docs_source_first_copy_paste_ready_with_real_paths_and_dependencies",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_dx_check_script_covers_source_first_copy_paste_ready_contract",
        "scripts/check-ui-components-dx.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn form_field_check2_marks_heroui_benchmark_docs_sync_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_heroui_benchmark_docs_sync_rules",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_heroui_strategy_and_component_docs_are_synchronized_and_indexable",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_dx_check_script_covers_heroui_benchmark_docs_sync_contract",
...
fn form_field_motion_contract_is_explicitly_na_for_runtime_attach_and_keeps_reduced_motion_noop_guards()
 {
    ...
    let platform_script = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-platforms.sh"),
    )
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_motion_contract_is_explicitly_na_for_runtime_attach_and_keeps_reduced_motion_noop_guards",
    ] {
        assert!(
            check2.contains(required),
...
fn form_field_ui_components_fixed_entry_files_follow_layered_boundaries() {
    ...
    let ui_components_lib =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/lib.rs"))
            .expect("ui-components lib.rs should be readable");
    let ui_components_field_form =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/field_form.rs"))
            .expect("ui-components field_form.rs should be readable");
    let ui_components_css =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/css.rs"))
            .expect("ui-components css.rs should be readable");
    let ui_components_root =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/root.rs"))
            .expect("ui-components root.rs should be readable");
    ...
    let entrypoints_script = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-entrypoints.sh"),
    )
    .expect("entrypoints check script should be readable");
    let ui_components_src_root = component_dir.join("../../crates/ui-components/src");
    ...
    for required in [
        ...
        assert!(
            ui_components_field_form.contains(required),
            "ui-components field_form.rs should keep form-field feature-gated entry `{required}`."
        );
    }
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_ui_components_fixed_entry_files_follow_layered_boundaries",
...
fn form_field_performance_governance_budget_is_defined_traceable_and_blocking() {
    ...
    let perf_script_source = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-performance.sh"),
    )
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_performance_governance_budget_is_defined_traceable_and_blocking",
    ] {
        assert!(
            check2.contains(required),
    ...
    let perf_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_performance_governance_budget_is_defined_traceable_and_blocking";
    assert!(
...
fn form_field_view_macro_complexity_is_bounded_via_semantic_subview_split() {
    ...
    let view = load_source("view");
    let component_dir = std::path::Path::new(env!("CARGO_MANIFEST_DIR"));
    let view_macro_script_source = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-view-macro.sh"),
    )
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_view_macro_complexity_is_controlled_by_semantic_subview_split",
    ] {
        assert!(
            check2.contains(required),
    ...
    let view_macro_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_view_macro_complexity_is_controlled_by_semantic_subview_split";
    assert!(
...
fn form_field_view_functional_split_prefers_plain_helpers_without_component_noise() {
    ...
    assert_eq!(
        ...
        "form-field view should keep only 2 component declarations (FormField + Switch); found {component_attr_count}."
    );
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_view_functional_split_prefers_plain_functions_over_extra_local_components",
    ] {
        assert!(
            check2.contains(required),
    ...
    let view_macro_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_view_functional_split_prefers_plain_functions_over_extra_local_components";
    assert!(
        view_macro_script_source.contains(view_macro_script_needle),
        "view-macro gate script should include `{view_macro_script_needle}`."
    );
...
fn form_field_static_fragments_are_constantized_or_absent_for_simple_layout() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_static_fragments_are_constantized_or_absent_for_simple_layout",
    ] {
        assert!(
            check2.contains(required),
    ...
    let view_macro_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_static_fragments_are_constantized_or_absent_for_simple_layout";
    assert!(
        view_macro_script_source.contains(view_macro_script_needle),
        "view-macro gate script should include `{view_macro_script_needle}`."
    );
...
fn form_field_inner_html_usage_is_forbidden_in_component_and_docs_examples() {
    ...
    let check2 = load_source("check2");
    let component_dir = std::path::Path::new(env!("CARGO_MANIFEST_DIR"));
    let inner_html_script_source = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-inner-html.sh"),
    )
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_inner_html_usage_is_forbidden_in_component_and_docs_examples",
    ] {
        assert!(
            check2.contains(required),
    ...
    let inner_html_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_inner_html_usage_is_forbidden_in_component_and_docs_examples";
    assert!(
...
fn form_field_wasm_debug_contract_is_na_and_feature_isolated() {
    ...
    let ui_components_cargo =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/Cargo.toml"))
            .expect("ui-components Cargo.toml should be readable");
    let ui_components_lib =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/lib.rs"))
            .expect("ui-components lib.rs should be readable");
    let docs_app_source =
    ...
    let wasm_debug_script_source = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-wasm-debug.sh"),
    )
    ...
    let wasm_debug_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_wasm_debug_contract_is_na_and_feature_isolated";
    assert!(
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_wasm_debug_contract_is_na_and_feature_isolated",
    ] {
        assert!(
            check2.contains(required),
...
fn form_field_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na",
    ] {
        assert!(
            check2.contains(required),
    ...
    let dx_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_dx_playground_supports_css_hot_reload_and_isolated_canvas_with_optional_persist_na";
    assert!(
        dx_script_source.contains(dx_script_needle),
        "dx gate script should include `{dx_script_needle}`."
    );
...
fn form_field_engineering_contract_uses_serde_protocol_and_keeps_tracing_runtime_boundaries() {
    ...
    let engineering_script_source = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-engineering.sh"),
    )
    ...
    let engineering_script_needle = "cargo test -p ui-components --test form_field_semantics --no-default-features --features component-form_field,inject-css form_field_engineering_contract_uses_serde_protocol_and_keeps_tracing_runtime_boundaries";
    assert!(
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_engineering_contract_uses_serde_protocol_and_keeps_tracing_runtime_boundaries",
    ] {
        assert!(
            check2.contains(required),
...
fn form_field_styles_use_defensive_variable_fallback_chain_with_ui_theme_ssot_terminals() {
    ...
    let script_source = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-contract-hygiene.sh"),
    )
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_styles_use_defensive_variable_fallback_chain_with_ui_theme_ssot_terminals",
    ] {
        assert!(
            check2.contains(required),
...
fn form_field_cascade_layer_and_runtime_style_contract_is_enforced() {
    ...
    let css_aggregate =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/css.rs"))
            .expect("ui-components css aggregation source should be readable");
    let ui_root =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/root.rs"))
            .expect("ui-components UiRoot source should be readable");
    let script_source = std::fs::read_to_string(
        component_dir.join("../../scripts/check-ui-components-contract-hygiene.sh"),
    )
    .expect("contract-hygiene gate script should be readable");
    ...
    for required in [
        ...
        assert!(
            ...
            "ui-components css entry should enforce cascade-layer contract `{required}`."
        );
    }
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_cascade_layer_and_runtime_style_contract_is_enforced",
    ] {
        assert!(
            check2.contains(required),
...
fn form_field_token_first_static_style_contract_is_enforced() {
    ...
    for required in [
        ...
        assert!(
            css_aggregate.contains(required),
            "ui-components css aggregation should include form-field style registration `{required}`."
        );
    }
...
fn form_field_tree_shaking_contract_is_feature_gated_without_global_reachability_leak() {
    ...
    let cargo_toml =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/Cargo.toml"))
            .expect("ui-components Cargo.toml should be readable for feature-chain checks");
    let lib_source =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/lib.rs"))
            .expect("ui-components lib.rs should be readable for feature-gate checks");
    let domain_mod_source =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/field_form.rs"))
            .expect("ui-components field_form.rs should be readable for feature-gate checks");
    let css_source =
        std::fs::read_to_string(component_dir.join("../../crates/ui-components/src/css.rs"))
            .expect("ui-components css.rs should be readable for style tree-shaking checks");
    ...
    for required in [
        ...
        assert!(
            ...
            "ui-components lib boundary should keep field_form export feature-gated via `{required}`."
        );
    }
    ...
    assert!(
        ...
        "field_form domain module should keep form_field source path behind component feature gate."
    );
    ...
    assert!(
        ...
        "ui-components css aggregation should gate form-field CSS by component feature."
    );
...
fn form_field_semantic_contract_tests_cover_branch_matrix_without_snapshot_dependency() {
    ...
    let workspace_semantics =
        include_str!("../../../crates/ui-components/tests/form_field_semantics.rs");
    ...
    for forbidden in ["toMatchSnapshot", "assert_snapshot!", "snapshot_diff"] {
        assert!(
            !local_semantics.contains(forbidden)
                && !workspace_semantics.contains(forbidden)
...
fn form_field_component_has_local_semantics_tests_and_checklist_evidence() {
    ...
    for required in [
        ...
        assert!(
            module.contains(required) || logic.contains(required),
    ...
    for required in [
        ...
        assert!(
            check2.contains(required),
            "form-field checklist should document ui-components boundary evidence `{required}`."
        );
    }
}
...
fn form_field_e2e_selector_stability_prefers_semantic_markers_and_settled_waits() {
    let check2 = load_source("check2");
    let e2e_contract = include_str!("../../../e2e/tests/docs_app_form_field_contract.spec.mjs");
    let e2e_script = include_str!("../../../scripts/check-ui-components-e2e-form-field.sh");
    ...
    assert!(
        check2.contains("scripts/check-ui-components-e2e-form-field.sh"),
...
fn form_field_check2_marks_e2e_selector_stability_item_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_e2e_contract_uses_semantic_selectors_and_settled_waits",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_e2e_contract_covers_repeatable_key_flow_and_copy_ready_source",
...
fn form_field_check2_marks_e2e_repeatable_key_flow_item_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_check2_documents_e2e_repeatable_key_flow_rules",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_e2e_key_flow_is_repeatable_and_failure_points_are_semantic",
        "scripts/check-ui-components-e2e-form-field.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn form_field_check2_marks_semantic_test_priority_item_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks",
...
fn form_field_check2_marks_rust_hygiene_contract_complete() {
    ...
    for required in [
        ...
        "crates/ui-components/tests/form_field_semantics.rs::form_field_rust_hygiene_contract_forbids_unwrap_expect_and_let_underscore_in_non_test_sources",
        "crates/ui-components/tests/form_field_semantics.rs::form_field_rust_hygiene_string_clone_hotspots_converge_to_cow_or_are_absent",
