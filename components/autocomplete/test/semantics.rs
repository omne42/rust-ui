...
const UI_COMPONENTS_AUTOCOMPLETE_SEMANTICS_SOURCE: &str =
    include_str!("../../../crates/ui-components/tests/autocomplete_semantics.rs");
...
fn check2_marks_file_placement_discipline_contract_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/autocomplete_semantics.rs::autocomplete_file_placement_discipline_is_strict_for_component_scope",
        "crates/ui-components/tests/autocomplete_semantics.rs::autocomplete_file_placement_check_script_covers_contract",
        "crates/ui-components/tests/autocomplete_semantics.rs::autocomplete_check2_marks_file_placement_discipline_contract_complete",
        "scripts/check-ui-components-component-files.sh",
...
fn check2_marks_hyper_structure_builder_item_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/autocomplete_semantics.rs::{autocomplete_hyper_structure_builder_spec_is_not_applicable_for_simple_component",
...
fn check2_marks_e2e_selector_stability_item_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/autocomplete_semantics.rs::{autocomplete_check2_documents_e2e_selector_and_stable_wait_rules",
...
fn check2_marks_e2e_repeatable_regression_item_complete() {
    ...
    for needle in [
        ...
        "crates/ui-components/tests/autocomplete_semantics.rs::{autocomplete_check2_documents_e2e_repeatable_key_flow_rules",
        "autocomplete_e2e_key_flow_is_repeatable_with_semantic_breakpoints",
