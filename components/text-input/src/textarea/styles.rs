...
.ui-textarea {
  ...
  --ui-textarea-label-line-height: var(--ui-line-height-150);
  --ui-textarea-meta-font-size: var(--ui-font-size-100);
  --ui-textarea-meta-line-height: var(--ui-line-height-100);
  --ui-textarea-input-font-size: var(--ui-font-size-150);
  --ui-textarea-input-line-height: var(--ui-line-height-150);
...
.ui-textarea__label {
  ...
  line-height: var(--ui-textarea-label-line-height);
  font-weight: 500;
  color: var(--ui-fg);
}
...
.ui-textarea__textarea {
  ...
  color: var(--ui-fg);
  font: inherit;
  font-size: var(--ui-textarea-input-font-size);
  line-height: var(--ui-textarea-input-line-height);
...
.ui-textarea__error {
  ...
  line-height: var(--ui-textarea-meta-line-height);
}
