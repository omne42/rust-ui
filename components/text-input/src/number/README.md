...
- `CSS Test`：加载 `components/text-input/src/number/styles.rs` 的原始样式，可在 scoped 区域实时覆盖并观察结果。
...
- 真实源码落点：
  - `components/text-input/src/number/mod.rs`
  - `components/text-input/src/number/logic.rs`
  - `components/text-input/src/number/view.rs`
  - `components/text-input/src/number/styles.rs`
  - `components/text-input/src/number/motion.rs`
