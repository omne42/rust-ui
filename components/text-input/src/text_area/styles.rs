...
.ui-text-area {
  ...
  --ui-text-area-label-line-height: var(--ui-line-height-150);
  --ui-text-area-meta-font-size: var(--ui-font-size-100);
  --ui-text-area-meta-line-height: var(--ui-line-height-100);
  --ui-text-area-input-font-size: var(--ui-font-size-150);
  --ui-text-area-input-line-height: var(--ui-line-height-150);
...
.ui-text-area__label {
  ...
  line-height: var(--ui-text-area-label-line-height);
  font-weight: 500;
  color: var(--ui-fg);
}
...
.ui-text-area__textarea {
  ...
  color: var(--ui-fg);
  font: inherit;
  font-size: var(--ui-text-area-input-font-size);
  line-height: var(--ui-text-area-input-line-height);
...
.ui-text-area__error {
  ...
  line-height: var(--ui-text-area-meta-line-height);
}
