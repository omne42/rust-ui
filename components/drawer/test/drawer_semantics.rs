...
fn drawer_type_system_and_semantic_markers_form_machine_readable_contract() {
    ...
    for needle in [
        ...
        "components/drawer/test/drawer_semantics.rs::drawer_type_system_and_semantic_markers_form_machine_readable_contract",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_escape_hatches_foreign_zone_contract_is_not_applicable() {
    ...
    for needle in [
        ...
        "components/drawer/test/drawer_semantics.rs::drawer_escape_hatches_foreign_zone_contract_is_not_applicable",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_ssr_and_cross_platform_compile_contract_is_documented_and_non_wasm_safe() {
    ...
    for needle in [
        ...
        "components/sheet/src/view.rs",
        "components/drawer/test/drawer_semantics.rs::drawer_ssr_and_cross_platform_compile_contract_is_documented_and_non_wasm_safe",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_headless_web_ssr_mutex_guard_is_preserved() {
    ...
    for needle in [
        ...
        "cargo check -p ui-headless --no-default-features --features web,ssr",
        "mutually exclusive",
        "components/drawer/test/drawer_semantics.rs::drawer_headless_web_ssr_mutex_guard_is_preserved",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_ui_motion_non_wasm_stub_contract_is_predictable_and_tooling_safe() {
    ...
    for needle in [
        ...
        "components/sheet/src/motion.rs",
        "cargo test -p ui-motion --test non_wasm_stub",
        "components/drawer/test/drawer_semantics.rs::drawer_ui_motion_non_wasm_stub_contract_is_predictable_and_tooling_safe",
    ] {
        assert!(
            check2_source.contains(needle),
...
fn drawer_reduced_motion_ssr_wasm_branches_keep_semantics_consistent() {
    ...
    for needle in [
        ...
        "if reduced_motion",
        "finish_exit.run(())",
        "components/drawer/test/drawer_semantics.rs::drawer_reduced_motion_ssr_wasm_branches_keep_semantics_consistent",
    ] {
        assert!(
            check2_source.contains(needle),
