...
fn carousel_simple_component_does_not_introduce_spec_rs() {
    let component_spec_path = carousel_component_src_dir().join("spec.rs");
    assert!(
        !component_spec_path.exists(),
        "Carousel is a simple component and should not introduce `components/carousel/src/spec.rs`."
    );

    let mod_source = load_source("src/carousel/mod.rs");
    ...
    let readme_source = load_source("../../components/carousel/src/README.md");
    let check2_source = load_source("../../components/carousel/check2.md");
    assert!(
    ...
    assert!(
        ...
        "Carousel checklist should keep the spec.rs guardrail for simple components."
    );
}

#[test]
fn carousel_token_first_static_styles_flow_through_css_aggregation_and_ui_root_injection() {
    let styles_source = load_source("src/carousel/styles.rs");
...
fn carousel_check2_marks_tree_shaking_feature_pruning_contract_complete() {
    ...
    for required in [
        ...
        "carousel_tree_shaking_script_enforces_component_minimal_feature_tree_and_budget",
        "carousel_check2_marks_tree_shaking_feature_pruning_contract_complete",
        "components/carousel/test/semantics.rs::carousel_tree_shaking_contract_keeps_feature_gated_entrypoints",
        "components/carousel/test/semantics.rs::carousel_tree_shaking_script_enforces_component_minimal_feature_tree_and_budget",
        "components/carousel/test/semantics.rs::carousel_check2_marks_tree_shaking_feature_pruning_contract_complete",
...
fn carousel_platform_build_contract_uses_explicit_web_ssr_features() {
    let carousel_manifest_source = load_source("../../components/carousel/Cargo.toml");
    let mod_source = load_source("src/carousel/mod.rs");
    let logic_source = load_source("src/carousel/logic.rs");
    let view_source = load_source("src/carousel/view.rs");
    let motion_source = load_source("src/carousel/motion.rs");
    ...
    for required in [
        ...
        assert!(
            carousel_manifest_source.contains(required),
...
fn carousel_motion_non_wasm_noop_contract_is_preserved() {
    ...
    let carousel_motion_source = load_source("src/carousel/motion.rs");
...
fn carousel_check2_marks_ui_components_fixed_entry_files_complete() {
    let source = load_source("../../components/carousel/check2.md");
    ...
    for needle in [
        ...
        "components/carousel/test/carousel/semantics.rs::carousel_ui_components_fixed_entry_files_follow_layered_boundaries",
        "components/carousel/test/carousel/semantics.rs::carousel_entrypoints_check_script_covers_fixed_entrypoint_contract",
        "components/carousel/test/carousel/semantics.rs::carousel_check2_marks_ui_components_fixed_entry_files_complete",
...
fn carousel_component_directory_standard_files_follow_contract_and_na_paths() {
    ...
    let view_source = load_source("src/carousel/view.rs");
    let motion_source = load_source("src/carousel/motion.rs");
    let checklist_source = load_source("../../components/carousel/check2.md");
    let component_src_dir = carousel_component_src_dir();
    ...
    for required in [
        ...
        "回归覆盖：`components/carousel/test/semantics.rs::carousel_component_directory_standard_files_follow_contract_and_na_paths`、`components/carousel/test/carousel/semantics.rs::carousel_component_directory_standard_files_follow_contract_and_na_paths`。",
        "门禁证据：`scripts/check-ui-component-files.sh` 新增 `carousel_component_directory_standard_files_follow_contract_and_na_paths` 命令，阻断目录落点回归。",
    ] {
        assert!(
...
fn carousel_file_placement_discipline_is_strict_for_component_scope() {
    for required in [
        "src/carousel/mod.rs",
        "src/carousel/logic.rs",
        "src/carousel/styles.rs",
        "src/carousel/view.rs",
        "src/carousel/motion.rs",
    ] {
        assert!(
            path_exists(required),
    ...
    let forbidden = "src/carousel/render.rs";
    assert!(
        !path_exists(forbidden),
    ...
    assert!(
        !path_exists("src/carousel/spec.rs"),
        "carousel is a simple component; `src/carousel/spec.rs` should remain absent in this scope.",
    );

    assert!(
        path_exists("src/carousel/protocol.rs"),
        "carousel keeps `src/carousel/protocol.rs` as sidecar contract file and should not regress.",
    );
}
...
fn carousel_check2_marks_file_placement_discipline_complete() {
    ...
    for needle in [
        ...
        "components/carousel/test/carousel/semantics.rs::carousel_file_placement_discipline_is_strict_for_component_scope",
        "components/carousel/test/carousel/semantics.rs::carousel_component_files_script_covers_file_placement_discipline",
        "components/carousel/test/carousel/semantics.rs::carousel_check2_marks_file_placement_discipline_complete",
...
fn carousel_hyper_structure_builder_spec_is_not_applicable_for_simple_component() {
    ...
    assert!(
        !path_exists("src/carousel/spec.rs"),
        "carousel is a simple component; `src/carousel/spec.rs` should remain absent for Hyper-Structure Builder gate.",
    );
...
fn carousel_check2_marks_hyper_structure_builder_contract_complete() {
    ...
    for needle in [
        ...
        "components/carousel/test/carousel/semantics.rs::carousel_hyper_structure_builder_spec_is_not_applicable_for_simple_component",
        "components/carousel/test/carousel/semantics.rs::carousel_component_files_script_covers_hyper_structure_builder_na_contract",
        "components/carousel/test/carousel/semantics.rs::carousel_check2_marks_hyper_structure_builder_contract_complete",
        "scripts/check-ui-component-files.sh",
...
fn carousel_context_compression_manifest_and_rbi_projection_are_present_and_current() {
    ...
    let manifest_source = load_source("../../components/carousel/src/Component.toml");
    let rbi_source = load_source("../../components/carousel/src/carousel.rbi");
    let view_source = load_source("../../components/carousel/src/view.rs");
...
fn carousel_check2_marks_context_compression_manifest_and_rbi_contract_complete() {
    ...
    for needle in [
        ...
        "components/carousel/test/carousel/semantics.rs::carousel_context_compression_manifest_and_rbi_projection_are_present_and_current",
        "components/carousel/test/carousel/semantics.rs::carousel_component_files_check_script_covers_context_compression_manifest_contract",
        "components/carousel/test/carousel/semantics.rs::carousel_check2_marks_context_compression_manifest_and_rbi_contract_complete",
        "scripts/check-ui-component-files.sh",
...
fn carousel_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement()
 {
    let local_semantics = load_source("../../components/carousel/test/semantics.rs");
    let aggregated_semantics = load_source("tests/carousel/semantics.rs");
    let view_source = load_source("src/carousel/view.rs");
    let todo_source = load_source("../../docs/plan/TODO.md");
    let script_source = load_source("../../scripts/check-ui-performance.sh");
    let check2_source = load_source("../../components/carousel/check2.md");
...
fn carousel_engineering_contract_marks_spec_serde_path_as_na_for_simple_component_scope() {
    let component_cargo = load_source("../../components/carousel/Cargo.toml");
    let ui_components_cargo = load_source("Cargo.toml");
    let mod_source = load_source("src/carousel/mod.rs");
    let i18n_source = load_source("src/carousel/i18n.rs");
    let logic_source = load_source("src/carousel/logic.rs");
    let view_source = load_source("src/carousel/view.rs");
    let styles_source = load_source("src/carousel/styles.rs");
    let motion_source = load_source("src/carousel/motion.rs");
    let check2_source = load_source("../../components/carousel/check2.md");
    let spec_path = carousel_component_src_dir().join("spec.rs");
    let protocol_path = carousel_component_src_dir().join("protocol.rs");
...
fn carousel_engineering_contract_keeps_tracing_semantics_unified_without_component_local_events() {
    ...
    let button_view_source = load_source("src/button/view.rs");
    let combined = [
        load_source("src/carousel/mod.rs"),
        load_source("src/carousel/i18n.rs"),
        load_source("src/carousel/logic.rs"),
        load_source("src/carousel/view.rs"),
        load_source("src/carousel/styles.rs"),
        load_source("src/carousel/motion.rs"),
    ]
    .join("\n");
...
fn carousel_is_exported_from_module_and_crate_root() {
    ...
    assert!(
        ...
        "ui should re-export external ui-carousel crate as `carousel`."
    );
    assert!(
        crate_source.contains(
            "pub use carousel::{Carousel, CarouselItem, CarouselMotion, CarouselOrientation, CarouselStrings};"
        ),
    ...
    assert!(
        ...
        "ui Cargo.toml should include optional ui-carousel dependency."
    );
}
...
fn carousel_logic_exposes_state_helpers() {
    ...
    for needle in [
        ...
        "pub fn resolve_aria_label_with_fallback(value: Option<String>, fallback: &str)",
        "pub fn resolve_label_with_fallback(value: Option<String>, fallback: &str)",
...
fn carousel_view_uses_logic_contracts_and_source_markers() {
    ...
    for forbidden in [
        ...
        "logic::resolve_initial_selected_index(",
        "if item_disabled {",
        ...
        assert!(
            !source.contains(forbidden),
            "Carousel view should not inline normalization/state-machine branches via `{forbidden}`."
        );
    }
}
...
fn carousel_exposes_keyboard_and_control_contracts() {
    ...
    for needle in [
        ...
        "let key_down = root_a11y.handlers.on_key_down.clone();",
...
fn carousel_a11y_i18n_l10n_contract_is_headless_driven_and_not_hardcoded_in_view() {
    ...
    for required in [
        "mod i18n;",
        "pub use i18n::CarouselStrings;",
        "DEFAULT_CONTROLS_ARIA_LABEL",
        "DEFAULT_INDICATORS_ARIA_LABEL",
        "DEFAULT_PREVIOUS_LABEL",
        "DEFAULT_NEXT_LABEL",
        "DEFAULT_INDICATOR_ARIA_LABEL_TEMPLATE",
    ] {
        assert!(
            ...
            "Carousel module should expose i18n defaults and bundle via `{required}`."
        );
    }
...
fn carousel_uses_active_highlight_motion_for_indicators() {
    ...
    for needle in [
        "pub fn sanitize_motion(motion: super::CarouselMotion)",
        "ui_motion::spring::sanitize_config(motion.spring, default.spring)",
        "pub fn attach_carousel_indicator_motion(",
        "attach_active_highlight_motion(container_ref, highlight_ref, active_index, option_id, motion);",
    ] {
        assert!(
            motion_source.contains(needle),
            "Carousel motion contract should include `{needle}`."
        );
    }
}
...
fn carousel_styles_avoid_fragile_dom_structure_guessing_and_view_inline_business_styles() {
    ...
    for required in [
        ...
        assert!(
            styles_source.contains(required),
            "Carousel visual state switching should rely on semantic selector `{required}`."
        );
    }
    ...
    for forbidden in [":nth-child", ":nth-of-type", ":has(", " + ", " ~ "] {
        assert!(
            !styles_source.contains(forbidden),
            "Carousel styles should avoid fragile DOM-structure selector `{forbidden}`."
        );
    }
    ...
    for forbidden in ["style=", "style:"] {
        assert!(
            !view_source.contains(forbidden),
            "Carousel view should not host inline business style logic `{forbidden}`."
        );
    }
}
...
#[test]
fn carousel_styles_consume_ui_theme_token_variables() {
    let styles_source = load_source("src/carousel/styles.rs");
    let theme_css_source = load_source("../ui-theme/src/css.rs");

    for needle in ["var(--ui-radius-lg)", "var(--ui-accent-fg)"] {
        assert!(
            styles_source.contains(needle),
            "Carousel styles should consume theme token variable `{needle}`."
        );
    }

    for needle in ["--ui-radius-lg:", "--ui-accent-fg:"] {
        assert!(
            theme_css_source.contains(needle),
            "ui-theme css output should define `{needle}`."
        );
    }

    for forbidden in ["var(--ui-radius-pill)", "var(--ui-accent-contrast)"] {
        assert!(
            !styles_source.contains(forbidden),
            "Carousel styles should not consume non-SSOT variable `{forbidden}`."
        );
    }
}
...
#[test]
fn carousel_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot() {
    let source =
        load_source("../../apps/docs-app/src/pages/components/pages/collections_command.rs");
    ...
    for needle in [
        ...
        assert!(
            source.contains(needle),
            "carousel docs-product copy-paste-ready contract should contain `{needle}`.",
        );
    }
}

#[test]
fn carousel_docs_are_source_first_copy_paste_ready_with_imports_copy_button_and_sync() {
    let docs_source =
        load_source("../../apps/docs-app/src/pages/components/pages/collections_command.rs");
    ...
    for needle in [
        ...
        assert!(
            ...
            "carousel source-first docs should contain `{needle}`.",
        );
    }
...
#[test]
fn carousel_dx_check_script_covers_docs_product_copy_paste_ready_contract() {
    let script_source = load_source("../../scripts/check-ui-dx.sh");
    ...
    for needle in [
        ...
        assert!(
            script_source.contains(needle),
            "DX check script should enforce carousel docs-product guard `{needle}`.",
        );
    }
}

#[test]
fn carousel_check2_documents_docs_product_copy_paste_ready_rules() {
    let source = load_source("../../components/carousel/check2.md");

    for needle in [
        "- [x] 文档即产品（Copy-Paste Ready）：`apps/docs-app` 必须新增 Playground（Hello World、状态矩阵、受控/非受控对照），支持流式/快照展现，并提供 Source-first 一键复制且补全 imports。",
        "Hello World / State Matrix / Controlled vs Uncontrolled / Streaming / Snapshot Contract / Source-first Copy-Paste",
        ...
        assert!(
            source.contains(needle),
            "carousel check2 docs-product section should reference `{needle}`.",
        );
    }
}

#[test]
fn carousel_check2_marks_docs_product_copy_paste_ready_contract_complete() {
    let source = load_source("../../components/carousel/check2.md");

    for needle in [
        "- [x] 文档即产品（Copy-Paste Ready）：`apps/docs-app` 必须新增 Playground（Hello World、状态矩阵、受控/非受控对照），支持流式/快照展现，并提供 Source-first 一键复制且补全 imports。",
        "carousel_check2_documents_docs_product_copy_paste_ready_rules",
        "carousel_docs_are_copy_paste_ready_with_hello_world_state_matrix_and_streaming_snapshot",
        "carousel_docs_are_source_first_copy_paste_ready_with_imports_copy_button_and_sync",
        "carousel_dx_check_script_covers_docs_product_copy_paste_ready_contract",
        "components/carousel/test/semantics.rs::carousel_docs_product_copy_paste_ready_contract_is_documented_and_scripted_locally",
    ] {
        assert!(
            source.contains(needle),
            "carousel check2 should keep docs-product completion marker `{needle}`.",
        );
    }
}
...
fn carousel_check2_marks_heroui_benchmark_docs_sync_contract_complete() {
    ...
    for needle in [
        ...
        "components/carousel/test/semantics.rs::carousel_check2_documents_heroui_benchmark_docs_sync_rules",
        "components/carousel/test/semantics.rs::carousel_heroui_strategy_and_component_docs_are_synchronized_and_indexable",
        "components/carousel/test/semantics.rs::carousel_dx_check_script_covers_heroui_benchmark_docs_sync_contract",
        "components/carousel/test/semantics.rs::carousel_check2_marks_heroui_benchmark_docs_sync_contract_complete",
        "components/carousel/test/carousel/semantics.rs::carousel_check2_documents_heroui_benchmark_docs_sync_rules",
        "components/carousel/test/carousel/semantics.rs::carousel_heroui_strategy_and_component_docs_are_synchronized_and_indexable",
        "components/carousel/test/carousel/semantics.rs::carousel_dx_check_script_covers_heroui_benchmark_docs_sync_contract",
        "components/carousel/test/carousel/semantics.rs::carousel_check2_marks_heroui_benchmark_docs_sync_contract_complete",
...
fn carousel_semantic_contract_matrix_is_asserted_by_semantics_instead_of_snapshots() {
    let view_source = load_source("src/carousel/view.rs");
    let logic_source = load_source("src/carousel/logic.rs");
    let component_semantics_source = load_source("../../components/carousel/test/semantics.rs");
    let workspace_semantics_source = load_source("tests/carousel/semantics.rs");
    ...
    for required in [
        ...
        assert!(
            view_source.contains(required),
            "Carousel semantic contract matrix should include `{required}` in view wiring.",
        );
    }
    ...
    for required in [
        ...
        assert!(
            ...
            "Workspace-level semantics suite should include `{required}`.",
        );
    }
    ...
    for (prefix, suffix) in [
        ...
        assert!(
            ...
            "Semantic contract suites should not rely on snapshot-only assertion `{forbidden}`.",
        );
    }
...
fn carousel_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks()
 {
    let view_source = load_source("src/carousel/view.rs");
    let local_semantics_source = load_source("../../components/carousel/test/semantics.rs");
    let semantics_source = load_source("tests/carousel/semantics.rs");
    let perf_script_source = load_source("../../scripts/check-ui-performance.sh");

    assert!(
        path_exists("../../components/carousel/test/semantics.rs")
            && path_exists("tests/carousel/semantics.rs"),
        "Carousel semantic-priority gate requires component/workspace `*_semantics.rs` suites.",
    );
...
fn carousel_check2_marks_e2e_selector_stability_item_complete() {
    ...
    for marker in [
        ...
        "components/carousel/test/carousel/semantics.rs::carousel_check2_documents_e2e_selector_and_stable_wait_rules",
        "components/carousel/test/carousel/semantics.rs::carousel_e2e_selector_contract_uses_semantic_markers_and_settled_waits",
        "components/carousel/test/carousel/semantics.rs::carousel_e2e_contract_covers_ready_and_settled_conditions_for_motion_paths",
        "components/carousel/test/carousel/semantics.rs::carousel_e2e_check_script_covers_selector_and_settled_wait_contract",
...
fn carousel_check2_marks_e2e_repeatable_key_flow_item_complete() {
    ...
    for marker in [
        ...
        "components/carousel/test/carousel/semantics.rs::carousel_check2_documents_e2e_repeatable_key_flow_rules",
        "components/carousel/test/carousel/semantics.rs::carousel_e2e_key_flow_is_repeatable_and_failure_points_are_semantic",
        "components/carousel/test/carousel/semantics.rs::carousel_e2e_high_risk_paths_cover_focus_keyboard_and_settled_semantic_breakpoints",
        "components/carousel/test/carousel/semantics.rs::carousel_check2_marks_e2e_repeatable_key_flow_item_complete",
        "components/carousel/scripts/check-ui-e2e-carousel.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
{
    let manifest_source = load_source("../../components/carousel/src/Component.toml");
    let protocol_source = load_source("src/carousel/protocol.rs");
    let rbi_source = load_source("../../components/carousel/src/carousel.rbi");
    let mod_source = load_source("src/carousel/mod.rs");
    let logic_source = load_source("src/carousel/logic.rs");
    let view_source = load_source("src/carousel/view.rs");
