...
fn carousel_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement()
 {
    ...
    let aggregated_semantics = load_source("tests/carousel_semantics.rs");
    let view_source = load_source("src/carousel/view.rs");
    let todo_source = load_source("../../docs/plan/TODO.md");
    let script_source = load_source("../../scripts/check-ui-performance.sh");
    let check2_source = load_source("../../components/carousel/check2.md");
...
fn carousel_check2_marks_heroui_benchmark_docs_sync_contract_complete() {
    ...
    for needle in [
        ...
        "components/carousel/test/carousel_semantics.rs::carousel_check2_documents_heroui_benchmark_docs_sync_rules",
        "components/carousel/test/carousel_semantics.rs::carousel_heroui_strategy_and_component_docs_are_synchronized_and_indexable",
        "components/carousel/test/carousel_semantics.rs::carousel_dx_check_script_covers_heroui_benchmark_docs_sync_contract",
...
fn carousel_semantic_contract_matrix_is_asserted_by_semantics_instead_of_snapshots() {
    ...
    let workspace_semantics_source = load_source("tests/carousel_semantics.rs");
