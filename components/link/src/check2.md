...
> 本轮核对证据（2026-02-19）：
> - `cargo fmt --all` ✅
> - `cargo test -p ui --no-default-features --features component-link --test link_semantics` ✅（8/8）
> - `cargo check -p ui --no-default-features --features component-link` ✅
> - `cargo clippy -p ui --no-default-features --features component-link --lib -- -D warnings` ✅
