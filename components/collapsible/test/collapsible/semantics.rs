...
fn collapsible_check2_marks_e2e_selector_stability_item_complete() {
    ...
    for marker in [
        ...
        "components/collapsible/test/collapsible/semantics.rs::collapsible_e2e_selector_contract_uses_semantic_markers_and_settled_waits",
...
fn collapsible_check2_marks_repeatable_keyflow_regression_item_complete() {
    ...
    for marker in [
        ...
        "components/collapsible/test/collapsible/semantics.rs::collapsible_e2e_regression_suite_contains_repeatable_disclosure_keyflow",
        "components/collapsible/scripts/check-ui-e2e-collapsible.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
...
fn collapsible_semantic_markers_changed_in_view_must_be_covered_by_semantics_checks() {
    ...
    let aggregated_semantics = load_source("tests/collapsible/semantics.rs");
