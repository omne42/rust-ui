...
fn collapsible_token_first_css_contract_is_centrally_injected() {
    let styles = load_source("src/styles.rs");
    let view = load_source("src/view.rs");
    let css_aggregator = load_source("../../crates/ui-components/src/css.rs");
...
fn collapsible_tree_shaking_contract_keeps_feature_gates_explicit() {
    let cargo = load_source("../../crates/ui-components/Cargo.toml");
    let lib = load_source("../../crates/ui-components/src/lib.rs");
    let css = load_source("../../crates/ui-components/src/css.rs");
