use crate::infield_button::{InfieldButtonStateInput, logic};
...
pub fn InfieldButton(
    ...
    let state = logic::resolve_state(InfieldButtonStateInput {
        quiet,
        invalid,
        disabled,
    ...
    view! {
        <button
            ...
            node_ref=node_ref
            class=class
            class:ui-infield-button--focus-visible=move || focus_ring.is_focus_visible.get()
        ...
        >
            <span class="ui-infield-button__label" data-slot="infield-button-label">
                {children()}
            </span>
        </button>
    }
