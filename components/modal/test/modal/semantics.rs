...
fn modal_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks()
 {
    ...
    let semantics_source = load_source("tests/modal/semantics.rs");
    let perf_script_source = load_source("../../scripts/check-ui-performance.sh");
...
fn modal_check2_marks_dx_contract_complete() {
    ...
    for needle in [
        ...
        "components/modal/test/modal/semantics.rs::modal_dx_playground_supports_css_hot_reload_without_wasm_rebuild",
        "components/modal/test/modal/semantics.rs::modal_dx_interactive_scope_keeps_isolated_canvas_and_context_visible_with_optional_persist_na",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn modal_check2_marks_engineering_contract_complete() {
    ...
    for needle in [
        ...
        "components/modal/test/modal/semantics.rs::modal_engineering_contract_uses_serde_protocol_and_structured_schema_defaults",
        "components/modal/test/modal/semantics.rs::modal_engineering_contract_keeps_tracing_semantics_unified_without_component_local_events",
        "components/modal/test/modal/semantics.rs::modal_engineering_contract_avoids_runtime_leaks_in_public_api_surface",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
            source.contains(needle),
...
fn modal_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement() {
    ...
    let aggregated_semantics = load_source("tests/modal/semantics.rs");
    let modal_view_source = load_source("../../components/modal/src/view.rs");
    let overlay_view_source = load_source("../../components/overlay/src/view.rs");
