...
fn load_source(rel_path: &str) -> String {
    ...
    if rel_path == "../../apps/docs-app/src/pages/components/pages/forms_extra.rs" {
        let parent_path =
            workspace_dir.join("apps/docs-app/src/pages/components/pages/forms_extra.rs");
        let child_path =
            workspace_dir.join("apps/docs-app/src/pages/components/pages/forms_extra/slider.rs");
