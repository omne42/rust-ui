...
fn bottom_sheet_check2_marks_semantic_test_priority_item_complete() {
    ...
    for marker in [
        "components/bottom-sheet/test/semantics.rs::bottom_sheet_semantic_contract_matrix_covers_interaction_paths_without_snapshot_only_assertions",
        "components/bottom-sheet/test/semantics.rs::bottom_sheet_semantic_test_priority_prefers_data_aria_role_and_source_contracts_over_snapshot_only_checks",
        "components/bottom-sheet/test/semantics.rs::bottom_sheet_semantics_and_performance_regression_cover_aria_data_focus_and_render_count_measurement",
        "scripts/check-ui-performance.sh",
        "Invalid cross-device link (os error 18)",
    ] {
        assert!(
