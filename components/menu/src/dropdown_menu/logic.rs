...
pub struct DropdownMenuDiscreteInput {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct DropdownMenuDiscreteProps {
    pub disabled: bool,
    pub action_mode: DropdownMenuActionMode,
}

#[derive(Clone)]
pub struct DropdownMenuOpenStateInput {
...
#[derive(Clone)]
pub struct DropdownMenuOpenState {
    pub open: Option<Signal<bool>>,
    pub default_open: Option<bool>,
    pub on_open_change: Option<Callback<bool>>,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct DropdownMenuPressResult {
    pub next_open: bool,
...
pub fn normalize_discrete_props(input: DropdownMenuDiscreteInput) -> DropdownMenuDiscreteProps {
    DropdownMenuDiscreteProps {
        disabled: input.is_disabled.unwrap_or(input.disabled),
        action_mode: DropdownMenuActionMode::from_bool(
...
pub fn resolve_trigger_press(
    ...
    current_open: bool,
) -> Option<DropdownMenuPressResult> {
    if trigger_disabled {
        return None;
    }
...
pub fn normalize_id_base(id_base: String) -> String {
    menu_state::normalize_id_base(id_base, "dropdown-menu")
}
