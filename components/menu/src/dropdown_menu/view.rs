...
pub fn DropdownMenu(
    ...
    let discrete_props = logic::normalize_discrete_props(logic::DropdownMenuDiscreteInput {
        is_disabled,
        disabled,
        is_close_on_action,
        close_on_action,
    });
    let open_state_input = logic::normalize_open_state(logic::DropdownMenuOpenStateInput {
        is_open,
        open,
        default_open,
        on_open_change,
