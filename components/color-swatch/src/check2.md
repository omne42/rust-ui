...
> - docs-app 已补 `ColorSwatch` 的 `Interactive Playground (展示 / Config / Code / CSS Test)` + `Comparison Matrix`，并新增 `src/color/swatch/README.md`（含 展示/config/code/css test 分区）。
