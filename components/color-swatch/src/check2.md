...
> 本轮核对证据（2026-02-19）：
> - `cargo fmt --all` ✅
> - `cargo check -p ui --no-default-features --features component-color_swatch` ✅
> - `cargo test -p ui --no-default-features --features component-color_swatch --test color_swatch_semantics` ✅（6/6）
> - `cargo clippy -p ui --no-default-features --features component-color_swatch --lib -- -D warnings` ✅
